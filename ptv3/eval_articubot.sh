...
for id in "${list[@]}"; do
    ...
    #     --low_level_exp_dir /project_data/held/yufeiw2/articubot_multitask/RoboGen-sim2real/data/close_push_low   \
    #     --low_level_ckpt_name epoch-52.ckpt   \
    #     --high_level_ckpt_name /project_data/held/yufeiw2/articubot_multitask/RoboGen-sim2real/test_PointNet2/exps/2025-10-05multinode-pointnext-load-cgn-world-articubot-format-aritucbot_new_cat_camera_random_close_w_more-pick_place/model_380001.pth \
    #     --eval_exp_name eval_pointnext-full-pick-and-place    \
    #     --exp_dir data/diverse_objects/open_the_door_${id}/task_open_the_door_of_the_storagefurniture_by_its_handle  \
    #     > data/logs/eval_${id}.log 2>&1 &
    ...
    #     --low_level_exp_dir /project_data/held/yufeiw2/articubot_multitask/RoboGen-sim2real/data/close_push_low   \
    #     --low_level_ckpt_name epoch-52.ckpt   \
    #     --high_level_ckpt_name /project_data/held/yufeiw2/articubot_multitask/RoboGen-sim2real/test_PointNet2/exps/2025-10-02PointNext_fp-articubot-50/model_212501.pth \
    #     --eval_exp_name eval_articubot-pointnext-fp-50     \
    #     --exp_dir data/diverse_objects/open_the_door_${id}/task_open_the_door_of_the_storagefurniture_by_its_handle  \
    #     > data/logs/eval_${id}.log 2>&1 &
    ...
    #     --low_level_exp_dir /project_data/held/yufeiw2/articubot_multitask/RoboGen-sim2real/data/close_push_low   \
    #     --low_level_ckpt_name epoch-52.ckpt   \
    #     --high_level_ckpt_name /project_data/held/yufeiw2/articubot_multitask/RoboGen-sim2real/test_PointNet2/exps/2025-09-25PointNet++-articubot-50/model_227501.pth \
    #     --eval_exp_name eval_pointnet_multigmm_50     \
    #     --exp_dir data/diverse_objects/open_the_door_${id}/task_open_the_door_of_the_storagefurniture_by_its_handle  \
    #     > data/logs/eval_${id}.log 2>&1 &

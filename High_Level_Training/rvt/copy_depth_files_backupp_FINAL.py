...
import numpy as np
import pickle
from rvt.libs.peract_colab.peract_colab.rlbench.utils import get_stored_demo
...
def convert_depth_with_near_far(
    ...
    far = ms[f"{camera}_camera_far"]
    near = ms[f"{camera}_camera_near"]

    # --- convert to metric depth ---
    depth_image = depth_normalized * (far - near) + near

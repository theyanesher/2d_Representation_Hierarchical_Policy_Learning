...
DATA_FOLDER = "/project_data/held/pratik/run_sample_basic_experiments/Bimanual_Manipulation/RVT2_GMM_Codebase/Bimanual_Manipulation/rvt/data" # "data"
...
DEMO_AUGMENTATION_EVERY_N = 1 #10  # sample n-th frame in demo

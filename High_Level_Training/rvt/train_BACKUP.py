...
def experiment(rank, cmd_args, devices, port):
    ...
    TRAIN_REPLAY_STORAGE_DIR = "/project_data/held/pratik/run_sample_basic_experiments/Bimanual_Manipulation/RVT2_GMM_Codebase/Bimanual_Manipulation/replay/replay_train/diffusion_policy_dataset" #"replay/replay_train"

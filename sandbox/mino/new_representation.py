...
faulty_gripper_pcd = torch.Tensor([[ 0.7394101,  -0.09697267, 0.36042207],
                               [ 0.7823303,  -0.10126281,  0.36081672],
                               [ 0.77152467, -0.07367267,  0.36031213],
                               [ 0.79993314, -0.0732672,   0.36052373]]).unsqueeze(0)
breakpoint()
gripper_pcd_to_10d_vector(faulty_gripper_pcd.to('cuda'))
faulty_gripper_pcd = torch.Tensor([[0.44298685, -0.01638007,  0.38927138], [ 0.45877537, -0.02858292,  0.35237175], [0.42146894,0.00780838,0.34829956],[0.44931108, -0.01713528,  0.3245842 ]]).unsqueeze(0)
gripper_pcd_to_10d_vector(faulty_gripper_pcd.to('cuda'))
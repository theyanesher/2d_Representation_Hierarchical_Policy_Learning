...
import torch
from diffusion_policy.model.language.attn import DenseBlock

class LanguageConditioning(nn.Module):
    def __init__(self, pe_fix = False, self_cross_ver = 1, lang_max_seq_len = 77, lang_emb_dim = 512, input_dim_before_seq = 512, im_channels = 64, activation = "lrelu"): # input_dim_before_seq = 128,
        super().__init__()
        self.pe_fix = pe_fix
    ...
    def forward(self, vis_proprio_cond_data, lang_emb):
        ...
        #     )
        import pdb; pdb.set_trace();
        bs = vis_proprio_cond_data.shape[0]

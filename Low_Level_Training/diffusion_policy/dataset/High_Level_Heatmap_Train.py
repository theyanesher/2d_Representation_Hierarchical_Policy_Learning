...
dataset = HighLevelHeatmapTrain(image_path=image_path, heatmap_path = heatmap_path, depth_path=depth_path, low_dim_path = low_dim_path, sequence_length = 16, pad_before = 4, pad_after = 4, use_wrist_camera = False)
# normalizer = dataset.get_normalizer()
# # import pdb; pdb.set_trace()
# print(dataset[718])
for i in range(len(dataset)):
    dataset[i]
#     print(i, dataset[i].keys)
# import pdb; pdb.set_trace()
# print(dataset[2000])

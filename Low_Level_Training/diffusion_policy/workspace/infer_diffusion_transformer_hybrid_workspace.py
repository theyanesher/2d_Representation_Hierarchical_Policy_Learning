...
def main(cfg):
    ...
    lastest_ckpt_path = "/project_data/held/pratik/run_sample_basic_experiments/Bimanual_Manipulation/Diffusion_Policy_Paper/Diff_Policy/diffusion_policy/data/outputs/2025.12.06/05.21.42_train_diffusion_unet_hybrid_high_level_heatmap_cnn/checkpoints/latest.ckpt" # workspace.get_checkpoint_path()

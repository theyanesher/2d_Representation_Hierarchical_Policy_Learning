...
## 500 objects (200 + camera randomizations), eval with noisy_pcd and real_world camera pose
...
python eval_robogen_with_goal_prediction.py \
    ...
    --eval_exp_name paper_eval_high_level_transformer_diffusion_500_obj_noisy_pcd_rerun_45132 \

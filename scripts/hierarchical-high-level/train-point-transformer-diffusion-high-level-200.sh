...
use_mlp=0
exp_name="paper-unet-diffusion-high-level-200-obj-1215"
...
torchrun --standalone --nproc_per_node=8 train_ddp.py \
    ...
    task.dataset.zarr_path=200_object_high_level  \
    ...
    policy.act3d_encoder_cfg.pointcloud_backbone=point_transformer \

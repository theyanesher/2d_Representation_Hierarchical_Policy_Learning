...
#     --model_invariant true \
#     --output_obj_pcd_only \
#     --eval_exp_name  paper_eval_high_level_weighted-displacement_500_obj_real_world_camera \
#     --real_world_camera 1
...
#     --model_invariant true \
#     --output_obj_pcd_only \
#     --eval_exp_name  paper_eval_high_level_weighted-displacement_500_obj_noisy_pcd \

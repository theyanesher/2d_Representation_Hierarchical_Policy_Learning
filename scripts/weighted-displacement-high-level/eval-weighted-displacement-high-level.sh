...
python eval_robogen_with_goal_PointNet.py \
    ...
    --high_level_ckpt_name /project_data/held/yufeiw2/RoboGen_sim2real/test_PointNet2/exps/pointnet2_super_model_invariant_2024-10-17_use_75_episodes_500-obj/model_60.pth \
    --pointnet_class PointNet2_super \
    --model_invariant true \
    --output_obj_pcd_only \
    --eval_exp_name  paper_eval_high_level_weighted-displacement_500_obj_model_2 \

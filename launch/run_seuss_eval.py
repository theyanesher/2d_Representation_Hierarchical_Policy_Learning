...
diverse_objects = [40147, 44817, 44962, 45132, 45219, 45243, 45332, 45378, 45384, 45463]
# bucket_tasks = [100443, 100444, 100452, 100454]
# faucet_tasks = [152, 153, 154, 168]
# foldingchair_tasks = [100531, 100532, 100557, 100561]
# laptop_tasks = [9968, 9992, 9996, 10040]
# stapler_tasks = [103099, 103100, 103104, 103111]
# toilet_tasks = [102622, 102630, 102634, 102645]
# storagefurniture_tasks = [46874, 46922, 46966, 48700]

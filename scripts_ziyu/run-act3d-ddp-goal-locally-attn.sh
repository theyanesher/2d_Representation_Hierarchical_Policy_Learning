...
exp_name="0723-10-obj-pred-goal-gripper-MLP-locally-self-attention-process-point-features"
...
torchrun --standalone --nproc_per_node=4 \
    ...
    dataloader.batch_size=42 \
    val_dataloader.batch_size=42 \
    ...
    policy.act3d_encoder_cfg.use_attn_for_point_features=locally_self_attention \

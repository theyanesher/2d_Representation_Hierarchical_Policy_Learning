...
exp_name="0806-50-obj-pred-goal-gripper-mlp-self-atten-backbone-unet-diffusion-epsilon"
exp_name="0808-50-obj-pred-goal-gripper-mlp-self-atten-backbone-unet-diffusion-v-prediction"

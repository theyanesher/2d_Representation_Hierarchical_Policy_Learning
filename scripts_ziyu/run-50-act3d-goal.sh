...
# exp_name="0730-50-obj-first-stage-pred-goal-gripper-pointnet-backbone-unet-diffusion-epsilon"
exp_name="0807-50-obj-pred-goal-gripper-pointnet-backbone-unet-diffusion-v-prediction"

...
exp_name="0705-ddp-obj-45448-hor-${horizon}-train-ep-${num_load_episodes}-gripper-pos-orn-goal-wzy"
...
torchrun --standalone --nproc_per_node=4 \
    ...
    policy.act3d_encoder_cfg.goal_mode=cross_attention_to_goal_pos_orn \
    load_checkpoint_path=/project_data/held/ziyuw2/Robogen-sim2real/3d_diffusion_policy/3D-Diffusion-Policy/3D-Diffusion-Policy/data/0705-ddp-obj-45448-hor-8-train-ep-260-gripper-pos-orn-goal-wzy/2024.07.06/10.04.51_train_dp3_robogen_open_door/checkpoints/epoch-175.ckpt

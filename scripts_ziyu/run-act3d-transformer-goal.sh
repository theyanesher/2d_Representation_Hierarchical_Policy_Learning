...
# singularity shell --bind /project_data/held/yufeiw2/RoboGen_sim2real/:/mnt/RoboGen_sim2real/ --nv /project_data/held/yufeiw2/robogen-dp3-act3d.sif
    ...
    # task.dataset.zarr_path="[/scratch/ziyu/dp3_demo/${save_data_name_0},/scratch/ziyu/dp3_demo/${save_data_name_1},/scratch/ziyu/dp3_demo/${save_data_name_2},/scratch/ziyu/dp3_demo/${save_data_name_3},/scratch/ziyu/dp3_demo/${save_data_name_4},/scratch/ziyu/dp3_demo/${save_data_name_5},/scratch/ziyu/dp3_demo/${save_data_name_6},/scratch/ziyu/dp3_demo/${save_data_name_7},/scratch/ziyu/dp3_demo/${save_data_name_8},/scratch/ziyu/dp3_demo/${save_data_name_9}]" \
    ...
    # task.dataset.zarr_path="[/scratch/yufei/dp3_demo/${save_data_name_0}]" \
    # task.env_runner.demo_experiment_path="[/scratch/yufei/dp3_demo/${save_data_name_0}]" \
    # task.env_runner.experiment_name="[${demo_name_0}]" \
    # task.env_runner.experiment_folder="[${exp_folder_0}]" \

# exp_name="0713-10-obj-pred-goal-gripper-conditional-transformer-train-ep-${num_load_episodes}"
...
torchrun --standalone --nproc_per_node=2 train_ddp.py\
    ...
    policy.act3d_encoder_cfg.in_channels=3 \
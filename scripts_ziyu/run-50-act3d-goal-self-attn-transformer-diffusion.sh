...
use_mlp=1
# exp_name="debug"
exp_name="0708-10-obj-pred-goal-gripper-MLP-train-ep-${num_load_episodes}-w-gripper-displacement-to-closest-objpoint-self-attention-correct-order"
exp_name="0715-10-obj-pred-goal-gripper-MLP-large-self-attention-process-point-features"

exp_name="0719-50-obj-pred-goal-gripper-pointnet-backbone-unet-diffusion"
exp_name="0721-50-obj-pred-goal-gripper-mlp-self-atten-backbone-unet-diffusion"
...
exp_name="0723-50-obj-pred-goal-gripper-mlp-self-attn-backbone-transformer-diffusion"
exp_name="0806-50-obj-pred-goal-gripper-mlp-self-attn-backbone-transformer-diffusion-epsilon"
...
torchrun --standalone --nproc_per_node=4 train_ddp.py \
    ...
    policy.act3d_encoder_cfg.use_attn_for_point_features=large_self_attention \
    policy.act3d_encoder_cfg.pointcloud_backbone=mlp \
    ...
    # load_checkpoint_path=/mnt/RoboGen_sim2real/3d_diffusion_policy/3D-Diffusion-Policy/3D-Diffusion-Policy/data/0715-10-obj-pred-goal-gripper-MLP-large-self-attention-process-point-features/2024.07.16/00.12.17_train_dp3_robogen_open_door/checkpoints/epoch-90.ckpt \

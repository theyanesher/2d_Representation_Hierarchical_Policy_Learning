...
exp_name="0724-50-obj-pred-goal-gripper-pointnet-solved-softmax-backbone-unet-diffusion"
exp_name="0725-50-obj-pred-goal-gripper-pointnetssg-backbone-unet-diffusion"
exp_name="0726-50-obj-pred-goal-only-reach-stage-gripper-pointnet-backbone-unet-diffusion"
...
torchrun --standalone --nproc_per_node=2 train_ddp.py \
    ...
    policy.act3d_encoder_cfg.use_attn_for_point_features=false \
    ...
    task.dataset.only_reach_stage=true \

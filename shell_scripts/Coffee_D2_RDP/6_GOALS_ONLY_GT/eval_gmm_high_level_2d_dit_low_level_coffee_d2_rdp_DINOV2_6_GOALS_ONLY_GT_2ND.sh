#!/usr/bin/env bash
# Hierarchical eval on Coffee_D2 with RDP-trained HL + 6_GOALS_ONLY_GT LL.
# Single seed (150000). Auto-resume: relaunch continues from the last completed episode.
...
# LL: 100-demo 6_GOALS_ONLY_GT run (RDP LL tree).
LL_EXP_DIR="${PROJ_ROOT}/SMITH_High_Level_FineTune/LOW_LEVEL_POLICIES/Coffee_d2_RDP/100_Demos/DinoV2_model_GMM_WCA_6_GOALS_ONLY_GT_coffee_D2_gmm_goal_gt_mix/"
...
OUTPUT_DIR="${SCRIPT_DIR}/GMM_HIGH_LEVEL_2D_DIT_LOW_LEVEL_COFFEE_RDP_50_SAMPLES_D2_DINOV2_6_GOALS_ONLY_GT_2ND_SEED"

...
# Single seed (100000). Auto-resume: relaunch continues from the last completed episode.
...
OUTPUT_DIR="${SCRIPT_DIR}/GMM_HIGH_LEVEL_2D_DIT_LOW_LEVEL_COFFEE_RDP_50_SAMPLES_D2_DINOV2_6_GOALS_ONLY_GT_1ST_SEED"

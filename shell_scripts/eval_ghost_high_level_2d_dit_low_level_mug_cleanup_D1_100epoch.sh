...
LL_EXP_DIR="${PROJ_ROOT}/SMITH_High_Level_FineTune/LOW_LEVEL_POLICIES/MugCleanup_D1/DiT_Goal_Gripper_Cond"
...
OUTPUT_DIR="${SMITH_MIMICGEN}/GHOST_HIGH_LEVEL_54_NO_MULTI_2D_DIT_LOW_LEVEL_100_MUG_CLEANUP_50_SAMPLES_D1_NO_MULTIMODAL_HIGHLEVEL_PLOT_INC"

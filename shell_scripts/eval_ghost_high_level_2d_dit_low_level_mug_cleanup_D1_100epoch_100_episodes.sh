...
HL_CKPT="${PROJ_ROOT}/SMITH_High_Level_FineTune/HIGH_LEVEL_POLICIES/Mug_Cleanup_d2/GHOST_High_Level_MULTIMODAL/periodic-epoch=epoch=54.ckpt"
LL_EXP_DIR="${PROJ_ROOT}/SMITH_High_Level_FineTune/LOW_LEVEL_POLICIES/MugCleanup_D1/100_Demos_Model/DinoV2_goal_gripper"
...
OUTPUT_DIR="${SMITH_MIMICGEN}/GHOST_HIGH_LEVEL_2D_DIT_LOW_LEVEL_GOAL_CONDITIONING_MUG_CLEANUP_50_SAMPLES_D1_DINOV2_100_episodes_3_MULTIMODAL_2ND_TRY"

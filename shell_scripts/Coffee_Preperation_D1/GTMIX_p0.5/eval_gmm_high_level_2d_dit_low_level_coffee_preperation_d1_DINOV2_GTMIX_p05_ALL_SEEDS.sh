#!/usr/bin/env bash
# Hierarchical eval on Coffee_Preperation_D1: multimodal Articubot HL + 2D DiT LL (GTMIX_p0.5).
# Single script, runs seeds 100000 / 150000 / 250000 SEQUENTIALLY.
# Per-seed outputs land in:
#   ${SCRIPT_DIR}/GMM_HIGH_LEVEL_2D_DIT_LOW_LEVEL_COFFEE_PREPERATION_50_SAMPLES_D1_DINOV2_GTMIX_p05_<NTH>_SEED/
...
# LL: 100-demo GTMIX_p0.5 run on Coffee_Preperation_D1.
LL_EXP_DIR="${PROJ_ROOT}/SMITH_High_Level_FineTune/LOW_LEVEL_POLICIES/Coffee_Preperation_D1/100_demos/DinoV2_model_Coffee_D2_GTMIX_p0.5_coffee_D2_gmm_goal_gt_mix/"
...
OUTPUT_BASE="GMM_HIGH_LEVEL_2D_DIT_LOW_LEVEL_COFFEE_PREPERATION_50_SAMPLES_D1_DINOV2_GTMIX_p05"

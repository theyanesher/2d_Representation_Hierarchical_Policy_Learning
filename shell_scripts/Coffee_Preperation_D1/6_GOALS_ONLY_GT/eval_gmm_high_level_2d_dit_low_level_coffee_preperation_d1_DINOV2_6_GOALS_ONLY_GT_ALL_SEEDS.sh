#!/usr/bin/env bash
# Hierarchical eval on Coffee_Preperation_D1: multimodal Articubot HL + 2D DiT LL (6_GOALS_ONLY_GT).
# Single script, runs seeds 100000 / 150000 / 250000 SEQUENTIALLY.
# Per-seed outputs land in:
#   ${SCRIPT_DIR}/GMM_HIGH_LEVEL_2D_DIT_LOW_LEVEL_COFFEE_PREPERATION_50_SAMPLES_D1_DINOV2_6_GOALS_ONLY_GT_<NTH>_SEED/
...
DATASET_PATH="${PROJ_ROOT}/SMITH_High_Level_FineTune/ORIGINAL_DATASET/coffee_preperation_d1.hdf5"

# HL: multimodal Articubot ckpt trained on Coffee_Preperation_d2.
HL_CKPT="${PROJ_ROOT}/SMITH_High_Level_FineTune/HIGH_LEVEL_POLICIES/Coffee_Preperation_d2/GHOST_High_Level/MULTIMODAL_GHOST_POLICY/periodic-epoch=epoch=54.ckpt"

# LL: 100-demo 6_GOALS_ONLY_GT run on Coffee_Preperation_D1.
LL_EXP_DIR="${PROJ_ROOT}/SMITH_High_Level_FineTune/LOW_LEVEL_POLICIES/Coffee_Preperation_D1/100_demos/DinoV2_model_GMM_WCA_6_GOALS_ONLY_GT_coffee_D2_gmm_goal_gt_mix/"
LL_CKPT="epoch_85.ckpt"
...
OUTPUT_BASE="GMM_HIGH_LEVEL_2D_DIT_LOW_LEVEL_COFFEE_PREPERATION_50_SAMPLES_D1_DINOV2_6_GOALS_ONLY_GT"

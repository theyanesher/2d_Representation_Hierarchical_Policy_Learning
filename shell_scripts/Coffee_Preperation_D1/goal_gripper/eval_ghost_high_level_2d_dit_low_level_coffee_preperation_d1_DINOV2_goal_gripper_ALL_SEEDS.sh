#!/usr/bin/env bash
# Hierarchical eval on Coffee_Preperation_D1: multimodal Articubot HL + 2D DiT LL (goal_gripper).
# Single script, runs seeds 100000 / 150000 / 250000 SEQUENTIALLY.
# Per-seed outputs land in:
#   ${SCRIPT_DIR}/GHOST_HIGH_LEVEL_2D_DIT_LOW_LEVEL_COFFEE_PREPERATION_50_SAMPLES_D1_DINOV2_goal_gripper_<NTH>_SEED/
...
# LL: 100-demo goal_gripper run on Coffee_Preperation_D1.
LL_EXP_DIR="${PROJ_ROOT}/SMITH_High_Level_FineTune/LOW_LEVEL_POLICIES/Coffee_Preperation_D1/100_demos/DinoV2_goal_gripper/"
...
OUTPUT_BASE="GHOST_HIGH_LEVEL_2D_DIT_LOW_LEVEL_COFFEE_PREPERATION_50_SAMPLES_D1_DINOV2_goal_gripper"

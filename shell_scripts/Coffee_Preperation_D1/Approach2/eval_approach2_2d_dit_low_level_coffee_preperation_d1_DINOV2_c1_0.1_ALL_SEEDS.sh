#!/usr/bin/env bash
# APPROACH 2 eval on Coffee_Preperation_D1: 2D DiT low-level policy ALONE.
#
...
#   ${SCRIPT_DIR}/APPROACH2_2D_DIT_LOW_LEVEL_COFFEE_PREPERATION_50_SAMPLES_D1_DINOV2_c1_0.1_<NTH>_SEED/
...
OUTPUT_BASE="APPROACH2_2D_DIT_LOW_LEVEL_COFFEE_PREPERATION_50_SAMPLES_D1_DINOV2_c1_0.1"

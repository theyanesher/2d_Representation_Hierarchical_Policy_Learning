...
VARIANT_LABEL="uvd"     # only used for OUTPUT_BASE naming
...
LL_RUN_NAME="05.49.22_coffee_preperation_D1_APPROACH2_uvd_c1_0.1_100demo_dinov2_DIT_coffee_preperation_goal_gmm_aux"

...
VARIANT_LABEL="AWE"     # only used for OUTPUT_BASE naming
...
LL_RUN_NAME="07.28.57_coffee_preperation_D1_APPROACH2_awe_c1_0.1_100demo_dinov2_DIT_coffee_preperation_goal_gmm_aux"

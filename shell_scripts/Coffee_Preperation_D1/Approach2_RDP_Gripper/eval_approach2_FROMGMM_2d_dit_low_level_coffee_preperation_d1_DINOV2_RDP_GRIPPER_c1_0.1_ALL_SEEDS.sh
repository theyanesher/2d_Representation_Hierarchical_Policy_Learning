...
# RDP_GRIPPER / FIXED_INTERVAL / RANDOM / RDP). It was trained with
#     policy.aux_goal_key=goal_gripper_pts_rdp_gripper
#     task=MimicGen_Tasks/coffee_preperation_goal_gmm_aux_rdp_gripper
...
#   ${SCRIPT_DIR}/APPROACH2_FROMGMM_RDP_GRIPPER_2D_DIT_LOW_LEVEL_COFFEE_PREPERATION_50_SAMPLES_D1_DINOV2_c1_0.1_<NTH>_SEED/
...
# LL: Approach 2 run on Coffee_Preperation_D1, RDP_GRIPPER keypoints, c1 = 0.1.
LL_EXP_DIR="${INFERENCE_ROOT}/APPROACH2_POLICIES/Coffee_Preperation_D1/Different_Keypoints/RDP_GRIPPER"
...
OUTPUT_BASE="APPROACH2_FROMGMM_RDP_GRIPPER_2D_DIT_LOW_LEVEL_COFFEE_PREPERATION_50_SAMPLES_D1_DINOV2_c1_0.1"
...
# parallel.
export TMPDIR="${TMPDIR:-/tmp}/approach2_fromgmm_rdp_gripper_eval_$$"
mkdir -p "${TMPDIR}"

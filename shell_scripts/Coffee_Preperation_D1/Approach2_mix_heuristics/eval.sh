...
# =============================================================================
TASK_LABEL="COFFEE_PREPARATION"        # only used for OUTPUT_BASE naming
VARIANT_LABEL="mix_heuristics"     # only used for OUTPUT_BASE naming
...
LL_RUN_NAME="00.00.43_coffee_preperation_D1_APPROACH2_mix_gripper_heuristic_orientation_heuristic_c1_0.1_100demo_dinov2_DIT_coffee_preperation_goal_gmm_aux"

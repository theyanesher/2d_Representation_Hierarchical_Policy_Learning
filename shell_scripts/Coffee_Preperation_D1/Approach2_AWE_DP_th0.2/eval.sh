...
VARIANT_LABEL="awe_dp_th0.2"     # only used for OUTPUT_BASE naming
...
LL_RUN_NAME="01.20.17_coffee_preperation_D1_APPROACH2_awe_dp_c1_0.1_100demo_dinov2_DIT_coffee_preperation_goal_gmm_aux"

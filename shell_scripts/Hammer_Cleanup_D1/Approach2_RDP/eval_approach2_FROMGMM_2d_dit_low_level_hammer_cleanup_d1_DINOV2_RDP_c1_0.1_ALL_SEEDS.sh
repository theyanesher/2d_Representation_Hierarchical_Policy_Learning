...
# BAYESIAN / BAYESIAN_VELOCITY / FIXED_INTERVAL / RANDOM / RDP_GRIPPER). It was trained with
#     policy.aux_goal_key=goal_gripper_pts_rdp
#     task=MimicGen_Tasks/hammercleanup_D1_goal_gmm_aux_rdp
# i.e. the subgoal keypoints that supervised the auxiliary GMM head were picked
# by the Ramer-Douglas-Peucker trajectory simplifier. That choice
...
#   ${SCRIPT_DIR}/APPROACH2_FROMGMM_RDP_2D_DIT_LOW_LEVEL_HAMMER_CLEANUP_50_SAMPLES_D1_DINOV2_c1_0.1_<NTH>_SEED/
...
# LL: Approach 2 run on Hammer_Cleanup_D1, RDP keypoints, c1 = 0.1.
LL_EXP_DIR="${INFERENCE_ROOT}/APPROACH2_POLICIES/Hammer_Cleanup_D1/Different_Keypoints/Approach2_RDP"
...
OUTPUT_BASE="APPROACH2_FROMGMM_RDP_2D_DIT_LOW_LEVEL_HAMMER_CLEANUP_50_SAMPLES_D1_DINOV2_c1_0.1"
...
# parallel.
export TMPDIR="${TMPDIR:-/tmp}/approach2_fromgmm_hammer_rdp_eval_$$"
mkdir -p "${TMPDIR}"

...
# BAYESIAN_VELOCITY_NO_OPEN_CLOSE keypoint source, c1 = 0.1.
#
...
# BAYESIAN / BAYESIAN_VELOCITY / FIXED_INTERVAL / RANDOM / RDP / RDP_GRIPPER). It was trained with
#     policy.aux_goal_key=goal_gripper_pts_bayesian_velocity_no_open_close
#     task=MimicGen_Tasks/hammercleanup_D1_goal_gmm_aux_bayesian_velocity_no_open_close
# i.e. the subgoal keypoints that supervised the auxiliary GMM head were picked
# by the Bayesian-velocity segmenter, but WITHOUT the gripper
# open/close transitions that the plain BAYESIAN_VELOCITY run forces in as
# extra keypoints -- i.e. purely velocity-derived changepoints. That choice
...
#   ${SCRIPT_DIR}/APPROACH2_FROMGMM_BAYESIAN_VELOCITY_NO_OPEN_CLOSE_2D_DIT_LOW_LEVEL_HAMMER_CLEANUP_50_SAMPLES_D1_DINOV2_c1_0.1_<NTH>_SEED/
...
# LL: Approach 2 run on Hammer_Cleanup_D1, BAYESIAN_VELOCITY_NO_OPEN_CLOSE keypoints, c1 = 0.1.
LL_EXP_DIR="${INFERENCE_ROOT}/APPROACH2_POLICIES/Hammer_Cleanup_D1/Different_Keypoints/Approach2_Bayesian_Velocity_NO_Open_Close"
...
OUTPUT_BASE="APPROACH2_FROMGMM_BAYESIAN_VELOCITY_NO_OPEN_CLOSE_2D_DIT_LOW_LEVEL_HAMMER_CLEANUP_50_SAMPLES_D1_DINOV2_c1_0.1"
...
# parallel.
export TMPDIR="${TMPDIR:-/tmp}/approach2_fromgmm_hammer_bayesian_velocity_no_open_close_eval_$$"
mkdir -p "${TMPDIR}"

...
# BAYESIAN_VELOCITY keypoint source, c1 = 0.1.
#
...
# BAYESIAN / FIXED_INTERVAL / RANDOM / RDP / RDP_GRIPPER). It was trained with
#     policy.aux_goal_key=goal_gripper_pts_bayesian_velocity
#     task=MimicGen_Tasks/hammercleanup_D1_goal_gmm_aux_bayesian_velocity
# i.e. the subgoal keypoints that supervised the auxiliary GMM head were picked
# by the Bayesian-velocity segmenter. That choice
...
#   ${SCRIPT_DIR}/APPROACH2_FROMGMM_BAYESIAN_VELOCITY_2D_DIT_LOW_LEVEL_HAMMER_CLEANUP_50_SAMPLES_D1_DINOV2_c1_0.1_<NTH>_SEED/
...
# LL: Approach 2 run on Hammer_Cleanup_D1, BAYESIAN_VELOCITY keypoints, c1 = 0.1.
LL_EXP_DIR="${INFERENCE_ROOT}/APPROACH2_POLICIES/Hammer_Cleanup_D1/Different_Keypoints/Approach2_Bayesian_Velocity"
...
OUTPUT_BASE="APPROACH2_FROMGMM_BAYESIAN_VELOCITY_2D_DIT_LOW_LEVEL_HAMMER_CLEANUP_50_SAMPLES_D1_DINOV2_c1_0.1"
...
# parallel.
export TMPDIR="${TMPDIR:-/tmp}/approach2_fromgmm_hammer_bayesian_velocity_eval_$$"
mkdir -p "${TMPDIR}"

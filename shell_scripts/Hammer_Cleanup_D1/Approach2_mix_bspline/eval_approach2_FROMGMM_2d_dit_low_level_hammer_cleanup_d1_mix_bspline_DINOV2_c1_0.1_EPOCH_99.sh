#!/usr/bin/env bash
# APPROACH 2 eval -- Hammer_Cleanup_D1, mix_bspline goal-source, FROM-GMM.
#
# Same conventions as
...
# mix_bspline-goal-source run (bspline + bspline_greville mixed, see
# generate_subgoals_nonvlm_D1.sh) synced via sync_best_checkpoints.sh.
...
VARIANT_LABEL="MIX_BSPLINE"        # only used for OUTPUT_BASE naming
...
LL_RUN_NAME="06.48.32_hammercleanup_D1_APPROACH2_mix_bspline_bspline_greville_c1_0.1_100demo_dinov2_DIT_hammercleanup_D1_goal_gmm_aux"

...
# =============================================================================
TASK_LABEL="KITCHEN"        # only used for OUTPUT_BASE naming
...
LL_RUN_NAME="02.05.02_kitchen_D1_APPROACH2_mix_gripper_heuristic_orientation_heuristic_c1_0.1_100demo_dinov2_DIT_kitchen_goal_gmm_aux"

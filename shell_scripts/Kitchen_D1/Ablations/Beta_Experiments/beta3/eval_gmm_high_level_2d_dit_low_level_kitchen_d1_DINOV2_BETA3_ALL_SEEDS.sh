...
#   ${SCRIPT_DIR}/GMM_HIGH_LEVEL_2D_DIT_LOW_LEVEL_KITCHEN_50_SAMPLES_D1_DINOV2_BETA3_<NTH>_SEED/
...
# LL: 100-demo WCA run on Kitchen_D1, top-2500 / alpha 1.0 / BETA 3, bs64,
# resumed from epoch 80 of the parent run.
LL_EXP_DIR="${LL_REPO}/outputs/2026.08.16/17.35.33_groot_GMM_WCA_100demo_dinov2_Kitchen_D1_top2500_alpha1.0_beta3_bs64_resumeE80_kitchen_D1_gmm_goal"
...
OUTPUT_BASE="GMM_HIGH_LEVEL_2D_DIT_LOW_LEVEL_KITCHEN_50_SAMPLES_D1_DINOV2_BETA3"
...
export TMPDIR="${TMPDIR:-/tmp}/kitchen_beta3_eval_$$"
mkdir -p "${TMPDIR}"

...
#     task=MimicGen_Tasks/kitchen_goal_gmm_aux   (default keypoints, no aux_goal_key)
...
# every c1 > 0 run is measured against -- compare with ../../Approach2_Bayesian/  (c1 = 0.1 baseline).
#
...
#   ${SCRIPT_DIR}/APPROACH2_NO_GMM_ABLATION_2D_DIT_LOW_LEVEL_KITCHEN_50_SAMPLES_D1_DINOV2_<NTH>_SEED/
...
# LL: Approach 2 NO-GMM ablation run on Kitchen_D1 (c1 = null).
LL_EXP_DIR="${INFERENCE_ROOT}/APPROACH2_POLICIES/Kitchen_D1/Ablations/NO_GMM_EXP"
...
OUTPUT_BASE="APPROACH2_NO_GMM_ABLATION_2D_DIT_LOW_LEVEL_KITCHEN_50_SAMPLES_D1_DINOV2"
...
# parallel.
export TMPDIR="${TMPDIR:-/tmp}/approach2_no_gmm_kitchen_no_gmm_eval_$$"
mkdir -p "${TMPDIR}"

...
#   ${SCRIPT_DIR}/GMM_HIGH_LEVEL_2D_DIT_LOW_LEVEL_KITCHEN_50_SAMPLES_D1_DINOV2_GTMIX_p05_<NTH>_SEED/
...
# LL: 100-demo GTMIX_p0.5 run on Kitchen_D1.
LL_EXP_DIR="${PROJ_ROOT}/SMITH_High_Level_FineTune/LOW_LEVEL_POLICIES/Kitchen_D1/100_demos/DinoV2_model_Kitchen_D1_GTMIX_p0.5_kitchen_D1_gmm_goal_gt_mix/"
...
OUTPUT_BASE="GMM_HIGH_LEVEL_2D_DIT_LOW_LEVEL_KITCHEN_50_SAMPLES_D1_DINOV2_GTMIX_p05"

...
#     task=MimicGen_Tasks/kitchen_goal_gmm_aux_fixed_interval
...
#   ${SCRIPT_DIR}/APPROACH2_FROMGMM_FIXED_INTERVAL_2D_DIT_LOW_LEVEL_KITCHEN_50_SAMPLES_D1_DINOV2_c1_0.1_<NTH>_SEED/
...
# LL: Approach 2 run on Kitchen_D1, FIXED_INTERVAL keypoints, c1 = 0.1.
LL_EXP_DIR="${INFERENCE_ROOT}/APPROACH2_POLICIES/Kitchen_D1/Different_Keypoints/Approach2_Fixed_Interval"
...
OUTPUT_BASE="APPROACH2_FROMGMM_FIXED_INTERVAL_2D_DIT_LOW_LEVEL_KITCHEN_50_SAMPLES_D1_DINOV2_c1_0.1"
...
# parallel.
export TMPDIR="${TMPDIR:-/tmp}/approach2_fromgmm_kitchen_fixed_interval_eval_$$"
mkdir -p "${TMPDIR}"

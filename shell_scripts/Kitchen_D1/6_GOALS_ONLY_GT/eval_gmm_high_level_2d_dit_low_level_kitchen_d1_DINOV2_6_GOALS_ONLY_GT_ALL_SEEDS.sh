#!/usr/bin/env bash
# Hierarchical eval on Kitchen_D1: multimodal Articubot HL + 2D DiT LL (6_GOALS_ONLY_GT).
# Single script, runs seeds 100000 / 150000 / 250000 SEQUENTIALLY.
# Per-seed outputs land in:
#   ${SCRIPT_DIR}/GMM_HIGH_LEVEL_2D_DIT_LOW_LEVEL_KITCHEN_50_SAMPLES_D1_DINOV2_6_GOALS_ONLY_GT_<NTH>_SEED/
...
# HL: multimodal Articubot ckpt trained on Kitchen_d2.
HL_CKPT="${PROJ_ROOT}/SMITH_High_Level_FineTune/HIGH_LEVEL_POLICIES/Kitchen_d2/periodic-epoch=epoch=74.ckpt"

# LL: 100-demo 6_GOALS_ONLY_GT run on Kitchen_D1.
LL_EXP_DIR="${PROJ_ROOT}/SMITH_High_Level_FineTune/LOW_LEVEL_POLICIES/Kitchen_D1/100_demos/DinoV2_model_GMM_WCA_6_GOALS_ONLY_GT_coffee_D2_gmm_goal_gt_mix/"
...
OUTPUT_BASE="GMM_HIGH_LEVEL_2D_DIT_LOW_LEVEL_KITCHEN_50_SAMPLES_D1_DINOV2_6_GOALS_ONLY_GT"
...
# Kitchen_D1 is registered in robosuite_task_zoo (not base robosuite), so both
# robosuite and the task-zoo must be on PYTHONPATH — unlike the Coffee reference
# this was ported from, whose envs live in base robosuite.

...
LL_EXP_DIR="${PROJ_ROOT}/SMITH_High_Level_FineTune/LOW_LEVEL_POLICIES/Coffee_d2/100_Demos/DinoV2_goal_gripper"
...
OUTPUT_DIR="${SCRIPT_DIR}/GHOST_HIGH_LEVEL_2D_DIT_LOW_LEVEL_COFFEE_50_SAMPLES_D2_DINOV2_goal_gripper_1ST_SEED"

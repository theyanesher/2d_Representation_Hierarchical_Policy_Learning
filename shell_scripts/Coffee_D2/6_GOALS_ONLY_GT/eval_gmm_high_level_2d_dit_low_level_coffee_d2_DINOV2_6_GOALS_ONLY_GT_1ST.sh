...
LL_EXP_DIR="${PROJ_ROOT}/SMITH_High_Level_FineTune/LOW_LEVEL_POLICIES/Coffee_d2/100_Demos/DinoV2_model_GMM_WCA_6_GOALS_ONLY_GT_coffee_D2_gmm_goal_gt_mix/"
...
OUTPUT_DIR="${SCRIPT_DIR}/GMM_HIGH_LEVEL_2D_DIT_LOW_LEVEL_COFFEE_50_SAMPLES_D2_DINOV2_6_GOALS_ONLY_GT_1ST_SEED"

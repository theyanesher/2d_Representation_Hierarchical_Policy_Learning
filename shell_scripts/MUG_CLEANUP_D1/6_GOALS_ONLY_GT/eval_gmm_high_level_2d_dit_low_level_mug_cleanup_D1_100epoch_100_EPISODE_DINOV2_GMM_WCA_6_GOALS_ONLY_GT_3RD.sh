...
# trained with:
#   task=MimicGen_Tasks/mug_cleanup_gmm_goal_gt_mix
#   policy.use_goal_cross_attention=true
#   policy.use_weighted_cross_attention=true
#   policy.gmm_top_k=6 (task.dataset.gt_mix_p=1.0 at train time)
#
...
LL_EXP_DIR="${PROJ_ROOT}/SMITH_High_Level_FineTune/LOW_LEVEL_POLICIES/MugCleanup_D1/100_Demos_Model/DinoV2_model_GMM_WCA_6_GOALS_ONLY_GT_mugcleanup_D1_gmm_goal_gt_mix/"
...
OUTPUT_DIR="${SCRIPT_DIR}/GMM_HIGH_LEVEL_2D_DIT_LOW_LEVEL_MUG_CLEANUP_50_SAMPLES_D1_DINOV2_GMM_WCA_6_GOALS_ONLY_GT_3RD_SEED"

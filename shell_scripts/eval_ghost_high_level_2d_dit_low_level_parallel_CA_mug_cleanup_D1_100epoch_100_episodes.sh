...
LL_EXP_DIR="${PROJ_ROOT}/SMITH_High_Level_FineTune/LOW_LEVEL_POLICIES/MugCleanup_D1/100_Demos_Model/DinoV2_goal_gripper_parallel_CA"
...
OUTPUT_DIR="${SMITH_MIMICGEN}/GHOST_HIGH_LEVEL_2D_DIT_LOW_LEVEL_GOAL_CONDITIONING_PARALLEL_CA_MUG_CLEANUP_50_SAMPLES_D1_DINOV2_100_episodes"

...
HL_CKPT="${PROJ_ROOT}/SMITH_High_Level_FineTune/HIGH_LEVEL_POLICIES/Hammer_Cleanup_d2/GHOST_High_Level_NO_MULTIMODAL/periodic-epoch=epoch=84.ckpt"
...
OUTPUT_DIR="${SMITH_MIMICGEN}/GHOST_HIGH_LEVEL_2D_DIT_LOW_LEVEL_HAMMER_CLEANUP_50_SAMPLES_D2_19_EPOCH_NO_MULTIMODAL_HIGHLEVEL"

...
#
# Coffee D2 variant. Same script as eval_ghost_high_level_2d_dit_low_level_coffee_d0.sh
# but with the Coffee_d2 HL/LL checkpoints and dataset, dumping results to a D2-tagged
# output directory.
#
...
HL_CKPT="${PROJ_ROOT}/SMITH_High_Level_FineTune/HIGH_LEVEL_POLICIES/Coffee_d2/GHOST_High_Level_NO_MULTIMODAL/CORRECT_FOUR_POINT_TRAIN/periodic-epoch=epoch=34.ckpt" #"/SMITH_High_Level_FineTune/HIGH_LEVEL_POLICIES/Coffee_d2/GHOST_High_Level/periodic-epoch=epoch=19.ckpt"
...
OUTPUT_DIR="${SMITH_MIMICGEN}/GHOST_HIGH_LEVEL_PROPER_CANONICAL_34th_FIRST_2D_DIT_LOW_LEVEL_COFFEE_50_SAMPLES_D2_100_EPOCH_NO_MULTIMODAL_HIGHLEVEL_PLOT_INC"

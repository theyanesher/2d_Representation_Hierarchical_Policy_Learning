...
LL_EXP_DIR="${PROJ_ROOT}/SMITH_High_Level_FineTune/LOW_LEVEL_POLICIES/Coffee_d2/Weighted_Cross_Attn_Cond/"
...
OUTPUT_DIR="GMM_HIGH_LEVEL_100_2D_DIT_LOW_LEVEL_COFFEE_50_SAMPLES_D2"

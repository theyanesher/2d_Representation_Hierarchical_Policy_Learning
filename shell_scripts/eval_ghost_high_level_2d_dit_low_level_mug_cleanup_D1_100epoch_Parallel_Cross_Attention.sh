...
#
# MugCleanup D1 variant. Same script as eval_ghost_high_level_2d_dit_low_level_coffee_d2_100epoch.sh
# but with the MugCleanup_D1 LL checkpoint, mug_cleanup_d1.hdf5 dataset, and a D1-tagged
# output directory.
#
# NOTE: the HL checkpoint lives under HIGH_LEVEL_POLICIES/Kitchen_d2/... — the path
# the user supplied points at a Kitchen_d2-trained HL being applied to MugCleanup_D1.
# If that's a typo, fix HL_CKPT below to point at the MugCleanup_D1 HL.
#
...
HL_CKPT="${PROJ_ROOT}/SMITH_High_Level_FineTune/HIGH_LEVEL_POLICIES/Mug_Cleanup_d2/GHOST_High_Level_NO_MULTIMODAL/periodic-epoch=epoch=54.ckpt"
LL_EXP_DIR="${PROJ_ROOT}/SMITH_High_Level_FineTune/LOW_LEVEL_POLICIES/MugCleanup_D1/Cross_Attention_DiT_Goal_Gripper_Cond"
LL_CKPT="epoch_70.ckpt"
...
OUTPUT_DIR="${SMITH_MIMICGEN}/GHOST_HIGH_LEVEL_54_NO_MULTI_2D_DIT_LOW_LEVEL_PARALLEL_CROSS_ATTENTION_100_MUG_CLEANUP_50_SAMPLES_D1_NO_MULTIMODAL_HIGHLEVEL_PLOT_INC"

#!/usr/bin/env bash
# Hierarchical eval on Coffee_Preperation_D1 with RDP-trained HL + 2D DiT LL (goal_gripper).
# Single script, runs seeds 100000 / 150000 / 250000 SEQUENTIALLY.
# Per-seed outputs land in:
#   ${SCRIPT_DIR}/GHOST_HIGH_LEVEL_2D_DIT_LOW_LEVEL_COFFEE_PREPERATION_RDP_50_SAMPLES_D1_DINOV2_goal_gripper_<NTH>_SEED/
...
# HL: RDP-trained multimodal Articubot ckpt for Coffee_Preperation_d2.
HL_CKPT="${PROJ_ROOT}/SMITH_High_Level_FineTune/HIGH_LEVEL_POLICIES/Coffee_Preperation_d2_RDP/periodic-epoch=epoch=74.ckpt"

# LL: 100-demo goal_gripper run on Coffee_Preperation_D1 (RDP LL tree).
LL_EXP_DIR="${PROJ_ROOT}/SMITH_High_Level_FineTune/LOW_LEVEL_POLICIES/Coffee_Preperation_D1_RDP/100_demos/goal_gripper/"
...
OUTPUT_BASE="GHOST_HIGH_LEVEL_2D_DIT_LOW_LEVEL_COFFEE_PREPERATION_RDP_50_SAMPLES_D1_DINOV2_goal_gripper"

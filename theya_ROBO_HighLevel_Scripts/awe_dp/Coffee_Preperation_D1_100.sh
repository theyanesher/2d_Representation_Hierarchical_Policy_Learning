...
#SBATCH -o /ocean/projects/cis240052p/eswaramo/code/2d_Representation_Hierarchical_Policy_Learning/theya_ROBO_HighLevel_Scripts/logs/coffee-prep-d1-high-level-awe-subgoa-100demo_%j.out
#SBATCH -e /ocean/projects/cis240052p/eswaramo/code/2d_Representation_Hierarchical_Policy_Learning/theya_ROBO_HighLevel_Scripts/logs/coffee-prep-d1-high-level-awe-subgoals-100demo_%j.err

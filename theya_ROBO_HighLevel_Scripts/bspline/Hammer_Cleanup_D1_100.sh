...
#SBATCH -o /ocean/projects/cis240052p/eswaramo/code/2d_Representation_Hierarchical_Policy_Learning/logs/hammer-cleanup-d1-high-level-bspline-subgoals-100demo_%j.out
#SBATCH -e /ocean/projects/cis240052p/eswaramo/code/2d_Representation_Hierarchical_Policy_Learning/logs/hammer-cleanup-d1-high-level-bspline-subgoals-100demo_%j.err

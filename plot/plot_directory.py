...
def plot_open_door_results(directory, num_exps=3, num_objs=10):
    json_results = []
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_exps", type=int, default=3)
    parser.add_argument("--num_objs", type=int, default=10)
    args = parser.parse_args()
    mean_result, std_result = plot_open_door_results(args.directory, args.num_exps, args.num_objs)
    print(mean_result)
    print(std_result)

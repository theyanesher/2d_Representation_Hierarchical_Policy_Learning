...
#SBATCH --job-name kitchen-d1-high-level-fixed-interval
#SBATCH -o /ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Code/2d_Representation_Hierarchical_Policy_Learning/ROBO_HIGH_LEVEL_TRAINING_SCRIPT/RDP_TRAINING_SCRIPTS/KITCHEN_D1_TASK/FIXED_INTERVAL_FOLDER/logs/job_%j.out
#SBATCH -e /ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Code/2d_Representation_Hierarchical_Policy_Learning/ROBO_HIGH_LEVEL_TRAINING_SCRIPT/RDP_TRAINING_SCRIPTS/KITCHEN_D1_TASK/FIXED_INTERVAL_FOLDER/logs/job_%j.err
#SBATCH --mail-type=END
#SBATCH --mail-user=pbhowal@andrew.cmu.edu

# Train articubot (GMM cross-displacement high-level policy) on KITCHEN_D1,
...
EXTRA_SRC_DIR="/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Dataset/D2/EXTRA_KEYPOINTS/KITCHEN_D1"
...
DEST_DATA_DIR="${SCRATCH_ROOT}/KITCHEN_D1"
DEST_EXTRA_DIR="${SCRATCH_ROOT}/KITCHEN_D1_extra_goals"
...
pixi run python scripts/train.py \
    ...
    "hydra.run.dir=logs/train_KITCHEN_D1_GOAL_SWAP_FIXED_INTERVAL_FULL/$(date +%Y-%m-%d/%H-%M-%S)" \

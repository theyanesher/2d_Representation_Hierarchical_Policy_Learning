...
#SBATCH --job-name mug-cleanup-d1-high-level-rdp-gripper
#SBATCH -o /ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Code/2d_Representation_Hierarchical_Policy_Learning/ROBO_HIGH_LEVEL_TRAINING_SCRIPT/RDP_TRAINING_SCRIPTS/MUG_CLEANUP_D1_TASK/RDP_GRIPPER_FOLDER/logs/job_%j.out
#SBATCH -e /ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Code/2d_Representation_Hierarchical_Policy_Learning/ROBO_HIGH_LEVEL_TRAINING_SCRIPT/RDP_TRAINING_SCRIPTS/MUG_CLEANUP_D1_TASK/RDP_GRIPPER_FOLDER/logs/job_%j.err
...
pixi run python scripts/train.py \
    ...
    "hydra.run.dir=logs/train_Mug_Cleanup_D1_GOAL_SWAP_RDP_GRIPPER_FULL_1000/$(date +%Y-%m-%d/%H-%M-%S)" \

...
DST=/scratch/pbhowal/Uncertainty_Dataset/LOW_LEVEL_NO_GMM_DATASET_GROOT_STYLE_DATASET/D2/ #/scratch/pbhowal/Uncertainty_Dataset/LOW_LEVEL_NO_GMM_DATASET_GROOT_STYLE_DATASET/D2    #Mug_Cleanup_D1/
...
run_job 0 kitchen_d1.hdf5             KITCHEN_D1             third_party/robogen/bocpd_config_kitchen.yaml
# run_job 0 coffee_preperation_d1.hdf5  COFFEE_PREPERATION_D1  third_party/robogen/bocpd_config_COFFEE_PREPERATION.yaml

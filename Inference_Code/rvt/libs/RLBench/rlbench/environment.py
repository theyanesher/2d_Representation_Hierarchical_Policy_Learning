...
class Environment(object):
    ...
    def launch(self):
        ...
        self._pyrep = PyRep()
        import os
        # Clear problematic Qt plugin path from OpenCV/conda
        os.environ.pop("QT_QPA_PLATFORM_PLUGIN_PATH", None)
        os.environ["QT_QPA_PLATFORM_PLUGIN_PATH"] = "/home/pratik_final/Downloads/Bimanual/RVT2_GMM_Inference/Final_Push/Bimanual_Manipulation/CoppeliaSim/CoppeliaSim_Player_V4_1_0_Ubuntu20_04" # "/home/pratik_final/anaconda3/envs/rvt_gmm/plugins/platforms"

        # Optionally, set headless platform
        os.environ["QT_QPA_PLATFORM"] = "xcb"  # or minimal

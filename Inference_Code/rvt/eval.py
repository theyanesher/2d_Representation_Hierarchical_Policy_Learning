...
from rlbench.action_modes.arm_action_modes import EndEffectorPoseViaLowLevelPolicy
...
def eval(
    ...
    arm_action_mode = EndEffectorPoseViaLowLevelPolicy("train_diffusion_unet_hybrid_workspace_EARLY.yaml") #EndEffectorPoseViaPlanning() "train_diffusion_transformer_lowdim_highlevel_heatmaps_workspace.yaml"
    ...
    for task_id in range(num_tasks):
        ...
        summaries = stats_accumulator._eval_acc._summaries
...
def _eval(args):
    ...
    for model_path in model_paths:
        ...
        scores = eval(
            ...
            episode_length=25, # args.episode_length

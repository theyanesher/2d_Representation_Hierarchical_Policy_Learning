...
for ep in range(1):
    visualize_folder(
        video_folder=f"outputs_11th_TRAIN_DATASET_ALL_EPISODE_TRAIN_PRETRAINED_RVT_ONLY_FIRST_FRAME/unnormalized_rgb/episode{ep}/",
        heatmap_folder=f"outputs_11th_TRAIN_DATASET_ALL_EPISODE_TRAIN_PRETRAINED_RVT_ONLY_FIRST_FRAME/unnormalized_heatmap_images/episode{ep}/",
        save_folder=f"all_episodes_11th_MVT_Output_Wrist_Camera_All_Episodes_TEST_DATASET_PRETRAINED_RVT_ONLY_FIRST_FRAME/output_videos_overlay_Haotian_11_episode{ep}_TEST_EPISODE",
        task="insert_onto_square_peg",
        fps=20,
        alpha=0.6,
    )

...
def main(cfg):
    ...
    lastest_ckpt_path = "/home/pratik_final/Downloads/Bimanual/Original_RVT2_Inference/RVT/runs/diffusion_policy_full_dataset_train/latest.ckpt" #"/home/pratik_final/Downloads/Bimanual/Original_RVT2_Inference/RVT/runs/diffusion_policy_full_dataset_train/latest.ckpt" #"/home/pratik_final/Downloads/Bimanual/Original_RVT2_Inference/RVT/diffusion_policy/Primary_Training_Outputs/checkpoints/epoch=0850-train_loss=0.006_WHOLE_DATASET_WRIST_CAM.ckpt" # workspace.get_checkpoint_path()
    ...
    with torch.no_grad():
        for i, batch in enumerate(inference_loader):
            ...
            print("trans",mse_trans, "quat", mse_quat, "open_close", mse_open_close, "abs", abs_mse)
            ...
            # if i >= 4:
            #     break
    print("AVERAGE", mse_trans_sum/len(dataset), mse_quat_sum/len(dataset), mse_open_close_sum/len(dataset),abs_mse_sum/len(dataset))

...
class DiffusionUnetHybridImagePolicy(BaseImagePolicy):
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        if self.obs_as_global_cond:
            ...
            this_nobs = dict_apply(nobs, lambda x: x[:,-To:,...].reshape(-1,*x.shape[2:])) #  :To  -To: IMPPPPPPPPPPPPPPPPPPPPPPPPPPPPP CHANGINGGGG TEMPORARYLY !!!!!!!!!!!!!!!!!!1
        ...
        # get action
        # start = To #- 1
        # end = start + 8 # self.n_action_steps
        # import pdb; pdb.set_trace();
        start = To - 1

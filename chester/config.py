...
HOME_FOLDER = 'yufeiw2'
PROJECT_NAME = 'RoboGen_sim2real'

# Make sure to use absolute path
REMOTE_DIR = {
    'seuss': '/data/yufeiw2/RoboGen_sim2real/',
    'autobot': '/project_data/held/yufeiw2/RoboGen_sim2real/'.format(HOME_FOLDER, PROJECT_NAME),
...
#SBATCH --exclude=compute-1-5,compute-1-9,compute-0-19,compute-0-17

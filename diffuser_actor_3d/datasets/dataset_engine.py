...
class RLBenchDataset(Dataset):
    ...
    def __getitem__(self, episode_id):
        ...
        # print("episode[0]: ", np.array(episode[0]).shape); print(episode[0])
        # print("episode[1]: ", np.array(episode[1]).shape)
        # print("episode[2]: ", np.array(episode[2]).shape); print(episode[2])
        # print("episode[3]: ", np.array(episode[3]).shape); print(episode[3])
        # print("episode[4]: ", np.array(episode[3]).shape); print(episode[4])
        ...
        #     if key not in ["task", "instr", "rgbs", "pcds"]:
        #         print(f"{key}: {values}")
        return ret_dict

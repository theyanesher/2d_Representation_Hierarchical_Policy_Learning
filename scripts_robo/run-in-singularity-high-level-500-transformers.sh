...
exp_name="test-500-obj-pred-goal-gripper-pointnet-backbone-diffusion-epsilon_CondTrans_Non_Mean_cent_3_GPU_ROBO_Resume_22ep_noAMP"
...
torchrun --standalone --nproc_per_node=3 \
    ...
    task.dataset.zarr_path="[\
        ...
        ${source_dir}/${save_data_name_216},\
        ${source_dir}/${save_data_name_217},\
        ${source_dir}/${save_data_name_218},\
        ${source_dir}/${save_data_name_219},\
        ${source_dir}/${save_data_name_220},\
        ${source_dir}/${save_data_name_221},\
        ${source_dir}/${save_data_name_222},\
        ${source_dir}/${save_data_name_223},\
        ${source_dir}/${save_data_name_224},\
        ${source_dir}/${save_data_name_225},\
        ${source_dir}/${save_data_name_226},\
        ${source_dir}/${save_data_name_227},\
        ${source_dir}/${save_data_name_228},\
        ${source_dir}/${save_data_name_229},\
        ${source_dir}/${save_data_name_230},\
        ${source_dir}/${save_data_name_231},\
        ${source_dir}/${save_data_name_232},\
        ${source_dir}/${save_data_name_233},\
        ${source_dir}/${save_data_name_234},\
        ${source_dir}/${save_data_name_235},\
        ${source_dir}/${save_data_name_236},\
        ${source_dir}/${save_data_name_237},\
        ${source_dir}/${save_data_name_238},\
        ${source_dir}/${save_data_name_239},\
        ${source_dir}/${save_data_name_240},\
        ${source_dir}/${save_data_name_241},\
        ${source_dir}/${save_data_name_242},\
        ${source_dir}/${save_data_name_243},\
        ${source_dir}/${save_data_name_244},\
        ${source_dir}/${save_data_name_245},\
        ${source_dir}/${save_data_name_246},\
        ${source_dir}/${save_data_name_247},\
        ${source_dir}/${save_data_name_248},\
        ${source_dir}/${save_data_name_249},\
        ${source_dir}/${save_data_name_250},\
        ${source_dir}/${save_data_name_251},\
        ${source_dir}/${save_data_name_252},\
        ${source_dir}/${save_data_name_253},\
        ${source_dir}/${save_data_name_254},\
        ${source_dir}/${save_data_name_255},\
        ${source_dir}/${save_data_name_256},\
        ${source_dir}/${save_data_name_257},\
        ${source_dir}/${save_data_name_258},\
        ${source_dir}/${save_data_name_259},\
        ${source_dir}/${save_data_name_260},\
        ${source_dir}/${save_data_name_261},\
        ${source_dir}/${save_data_name_262},\
        ${source_dir}/${save_data_name_263},\
        ${source_dir}/${save_data_name_264},\
        ${source_dir}/${save_data_name_265},\
        ${source_dir}/${save_data_name_266},\
        ${source_dir}/${save_data_name_267},\
        ${source_dir}/${save_data_name_268},\
        ${source_dir}/${save_data_name_269},\
        ${source_dir}/${save_data_name_270},\
        ${source_dir}/${save_data_name_271},\
        ${source_dir}/${save_data_name_272},\
        ${source_dir}/${save_data_name_273},\
        ${source_dir}/${save_data_name_274},\
        ${source_dir}/${save_data_name_275},\
        ${source_dir}/${save_data_name_276},\
        ${source_dir}/${save_data_name_277},\
        ${source_dir}/${save_data_name_278},\
        ${source_dir}/${save_data_name_279},\
        ${source_dir}/${save_data_name_280},\
        ${source_dir}/${save_data_name_281},\
        ${source_dir}/${save_data_name_282},\
        ${source_dir}/${save_data_name_283},\
        ${source_dir}/${save_data_name_284},\
        ${source_dir}/${save_data_name_285},\
        ${source_dir}/${save_data_name_286},\
        ${source_dir}/${save_data_name_287},\
        ${source_dir}/${save_data_name_288},\
        ${source_dir}/${save_data_name_289},\
        ${source_dir}/${save_data_name_290},\
        ${source_dir}/${save_data_name_291},\
        ${source_dir}/${save_data_name_292},\
        ${source_dir}/${save_data_name_293},\
        ${source_dir}/${save_data_name_294},\
        ${source_dir}/${save_data_name_295},\
        ${source_dir}/${save_data_name_296},\
        ${source_dir}/${save_data_name_297},\
        ${source_dir}/${save_data_name_298},\
        ${source_dir}/${save_data_name_299},\
        ${source_dir}/${save_data_name_300},\
        ${source_dir}/${save_data_name_301},\
        ${source_dir}/${save_data_name_302},\
        ${source_dir}/${save_data_name_303},\
        ${source_dir}/${save_data_name_304},\
        ${source_dir}/${save_data_name_305},\
        ${source_dir}/${save_data_name_306},\
        ${source_dir}/${save_data_name_307},\
        ${source_dir}/${save_data_name_308},\
        ${source_dir}/${save_data_name_309},\
        ${source_dir}/${save_data_name_310},\
        ${source_dir}/${save_data_name_311},\
        ${source_dir}/${save_data_name_312},\
        ${source_dir}/${save_data_name_313},\
        ${source_dir}/${save_data_name_314},\
        ${source_dir}/${save_data_name_315},\
        ${source_dir}/${save_data_name_316},\
        ${source_dir}/${save_data_name_317},\
        ${source_dir}/${save_data_name_318},\
        ${source_dir}/${save_data_name_319},\
        ${source_dir}/${save_data_name_320},\
        ${source_dir}/${save_data_name_321},\
        ${source_dir}/${save_data_name_322},\
        ${source_dir}/${save_data_name_323},\
        ${source_dir}/${save_data_name_324},\
        ${source_dir}/${save_data_name_325},\
        ${source_dir}/${save_data_name_326},\
        ${source_dir}/${save_data_name_327},\
        ${source_dir}/${save_data_name_328},\
        ${source_dir}/${save_data_name_329},\
        ${source_dir}/${save_data_name_330},\
        ${source_dir}/${save_data_name_331},\
        ${source_dir}/${save_data_name_332},\
        ${source_dir}/${save_data_name_333},\
        ${source_dir}/${save_data_name_334},\
        ${source_dir}/${save_data_name_335},\
        ${source_dir}/${save_data_name_336},\
        ${source_dir}/${save_data_name_337},\
        ${source_dir}/${save_data_name_338},\
        ${source_dir}/${save_data_name_339},\
        ${source_dir}/${save_data_name_340},\
        ${source_dir}/${save_data_name_341},\
        ${source_dir}/${save_data_name_342},\
        ${source_dir}/${save_data_name_343},\
        ${source_dir}/${save_data_name_344},\
        ${source_dir}/${save_data_name_345},\
        ${source_dir}/${save_data_name_346},\
        ${source_dir}/${save_data_name_347},\
        ${source_dir}/${save_data_name_348},\
        ${source_dir}/${save_data_name_349},\
        ${source_dir}/${save_data_name_350},\
        ${source_dir}/${save_data_name_351},\
        ${source_dir}/${save_data_name_352},\
        ${source_dir}/${save_data_name_353},\
        ${source_dir}/${save_data_name_354},\
        ${source_dir}/${save_data_name_355},\
        ${source_dir}/${save_data_name_356},\
        ${source_dir}/${save_data_name_357},\
        ${source_dir}/${save_data_name_358},\
        ${source_dir}/${save_data_name_359},\
        ${source_dir}/${save_data_name_360},\
        ${source_dir}/${save_data_name_361},\
        ${source_dir}/${save_data_name_362},\
        ${source_dir}/${save_data_name_363},\
        ${source_dir}/${save_data_name_364},\
        ${source_dir}/${save_data_name_365},\
        ${source_dir}/${save_data_name_366},\
        ${source_dir}/${save_data_name_367},\
        ${source_dir}/${save_data_name_368},\
        ${source_dir}/${save_data_name_369},\
        ${source_dir}/${save_data_name_370},\
        ${source_dir}/${save_data_name_371},\
        ${source_dir}/${save_data_name_372},\
        ${source_dir}/${save_data_name_373},\
        ${source_dir}/${save_data_name_374},\
        ${source_dir}/${save_data_name_375},\
        ${source_dir}/${save_data_name_376},\
        ${source_dir}/${save_data_name_377},\
        ${source_dir}/${save_data_name_378},\
        ${source_dir}/${save_data_name_379},\
        ${source_dir}/${save_data_name_380},\
        ${source_dir}/${save_data_name_381},\
        ${source_dir}/${save_data_name_382},\
        ${source_dir}/${save_data_name_383},\
        ${source_dir}/${save_data_name_384},\
        ${source_dir}/${save_data_name_385},\
        ${source_dir}/${save_data_name_386},\
        ${source_dir}/${save_data_name_387},\
        ${source_dir}/${save_data_name_388},\
        ${source_dir}/${save_data_name_389},\
        ${source_dir}/${save_data_name_390},\
        ${source_dir}/${save_data_name_391},\
        ${source_dir}/${save_data_name_392},\
        ${source_dir}/${save_data_name_393},\
        ${source_dir}/${save_data_name_394},\
        ${source_dir}/${save_data_name_395},\
        ${source_dir}/${save_data_name_396},\
        ${source_dir}/${save_data_name_397},\
        ${source_dir}/${save_data_name_398},\
        ${source_dir}/${save_data_name_399},\
        ${source_dir}/${save_data_name_400},\
        ${source_dir}/${save_data_name_401},\
        ${source_dir}/${save_data_name_402},\
        ${source_dir}/${save_data_name_403},\
        ${source_dir}/${save_data_name_404},\
        ${source_dir}/${save_data_name_405},\
        ${source_dir}/${save_data_name_406},\
        ${source_dir}/${save_data_name_407},\
        ${source_dir}/${save_data_name_408},\
        ${source_dir}/${save_data_name_409},\
        ${source_dir}/${save_data_name_410},\
        ${source_dir}/${save_data_name_411},\
        ${source_dir}/${save_data_name_412},\
        ${source_dir}/${save_data_name_413},\
        ${source_dir}/${save_data_name_414},\
        ${source_dir}/${save_data_name_415},\
        ${source_dir}/${save_data_name_416},\
        ${source_dir}/${save_data_name_417},\
        ${source_dir}/${save_data_name_418},\
        ${source_dir}/${save_data_name_419},\
        ${source_dir}/${save_data_name_420},\
        ${source_dir}/${save_data_name_421},\
        ${source_dir}/${save_data_name_422},\
        ${source_dir}/${save_data_name_423},\
        ${source_dir}/${save_data_name_424},\
        ${source_dir}/${save_data_name_425},\
        ${source_dir}/${save_data_name_426},\
        ${source_dir}/${save_data_name_427},\
        ${source_dir}/${save_data_name_428},\
        ${source_dir}/${save_data_name_429},\
        ${source_dir}/${save_data_name_430},\
        ${source_dir}/${save_data_name_431},\
        ${source_dir}/${save_data_name_432},\
        ${source_dir}/${save_data_name_433},\
        ${source_dir}/${save_data_name_434},\
        ${source_dir}/${save_data_name_435},\
        ${source_dir}/${save_data_name_436},\
        ${source_dir}/${save_data_name_437},\
        ${source_dir}/${save_data_name_438},\
        ${source_dir}/${save_data_name_439},\
        ${source_dir}/${save_data_name_440},\
        ${source_dir}/${save_data_name_441},\
        ${source_dir}/${save_data_name_442},\
        ${source_dir}/${save_data_name_443},\
        ${source_dir}/${save_data_name_444},\
        ${source_dir}/${save_data_name_445},\
        ${source_dir}/${save_data_name_446},\
        ${source_dir}/${save_data_name_447},\
        ${source_dir}/${save_data_name_448},\
        ${source_dir}/${save_data_name_449},\
        ${source_dir}/${save_data_name_450},\
        ${source_dir}/${save_data_name_451},\
        ${source_dir}/${save_data_name_452},\
        ${source_dir}/${save_data_name_453},\
        ${source_dir}/${save_data_name_454},\
        ${source_dir}/${save_data_name_455},\
        ${source_dir}/${save_data_name_456},\
        ${source_dir}/${save_data_name_457},\
        ${source_dir}/${save_data_name_458},\
        ${source_dir}/${save_data_name_459},\
        ${source_dir}/${save_data_name_460},\
        ${source_dir}/${save_data_name_461},\
        ${source_dir}/${save_data_name_462}\
    ]"\
    ...
    dataloader.batch_size=56 \
    val_dataloader.batch_size=56 \
    ...
    load_checkpoint_path="/mnt/RoboGen_sim2real/3d_diffusion_policy/3D-Diffusion-Policy/3D-Diffusion-Policy/data/test-500-obj-pred-goal-gripper-pointnet-backbone-diffusion-epsilon_CondTrans_Non_Mean_cent_3_GPU_ROBO_Resume_12ep/2024.11.07/01.55.40_train_dp3_robogen_open_door/checkpoints/epoch-22.ckpt" \

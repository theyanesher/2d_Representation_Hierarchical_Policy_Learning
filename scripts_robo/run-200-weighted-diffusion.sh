...
use_mlp=0
# exp_name="0811-200-obj-pred-goal-gripper-PointNet2-backbone-UNet-diffusion-ep-${num_load_episodes}-agumentation-pcd"

exp_name="0827-200-obj-pred-goal-gripper-pointnet-weighted-diffusion-epsilon"
torchrun --standalone --nproc_per_node=4 train_ddp.py \
    ...
    load_checkpoint_path=/ocean/projects/cis240052p/ywang59/RoboGen_sim2real/3d_diffusion_policy/3D-Diffusion-Policy/3D-Diffusion-Policy/data/0827-200-obj-pred-goal-gripper-pointnet-weighted-diffusion-epsilon/2024.08.30/01.55.52_train_dp3_robogen_open_door/checkpoints/latest.ckpt

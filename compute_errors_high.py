...
# 所有任务列表
categories = {
    "bucket": [100435, 100441],
    "faucet": [149, 960, 991],
    "foldingchair": [100520, 100521, 100526],
    "laptop": [9748, 9912, 9960],
    "stapler": [102990, 103095],
    "toilet": [101320, 102620, 102621],
    "storagefurniture": [41510, 45448, 46462, 46732, 46801],
}

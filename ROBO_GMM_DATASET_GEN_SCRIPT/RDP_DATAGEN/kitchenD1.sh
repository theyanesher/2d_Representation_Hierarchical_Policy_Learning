...
#SBATCH -t 12:00:00
#SBATCH --job-name kitchen-d1-rdp-pred-gen
...
# Generate per-frame GMM prediction npz files for KITCHEN_D1 by running the
...
#      EXTRA_KEYPOINTS/KITCHEN_D1_GMM_PRED/ (with a free-space guard first —
...
FINAL_OCEAN_DIR="/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Dataset/D2/EXTRA_KEYPOINTS/KITCHEN_D1_GMM_PRED"

# --- checkpoint (EDIT HERE to change) --------------------------------------
CKPT_PATH="${REPO_DIR}/logs/train_KITCHEN_D1_GOAL_SWAP_RDP_100demo/EDIT_ME_DATE/EDIT_ME_TIME/checkpoints/periodic-epoch=epoch=99.ckpt"
if [ ! -f "${CKPT_PATH}" ]; then
...
DEST_PRED_DIR="${SCRATCH_ROOT}/KITCHEN_D1_GMM_PRED"  # generator outputs

...
#SBATCH -t 12:00:00
#SBATCH --job-name coffee-d2-rdp-pred-gen
#SBATCH -o /ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Code/2d_Representation_Hierarchical_Policy_Learning/ROBO_GMM_DATASET_GEN_SCRIPT/RDP_DATAGEN/logs/job_%j.out
#SBATCH -e /ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Code/2d_Representation_Hierarchical_Policy_Learning/ROBO_GMM_DATASET_GEN_SCRIPT/RDP_DATAGEN/logs/job_%j.err
#SBATCH --mail-type=END
#SBATCH --mail-user=pbhowal@andrew.cmu.edu

# Generate per-frame GMM prediction npz files for Coffee_D2 by running the
...
#      EXTRA_KEYPOINTS/Coffee_D2_GMM_PRED/ (with a free-space guard first —
...
FINAL_OCEAN_DIR="/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Dataset/D2/EXTRA_KEYPOINTS/Coffee_D2_GMM_PRED"

# --- checkpoint (EDIT HERE to change) --------------------------------------
CKPT_PATH="${REPO_DIR}/logs/train_Coffee_D2_GOAL_SWAP_RDP_100demo/2026-07-05/16-52-17/checkpoints/periodic-epoch=epoch=44.ckpt"
if [ ! -f "${CKPT_PATH}" ]; then
...
DEST_NPZ_DIR="${SCRATCH_ROOT}/Coffee_D2_npz"        # staged inputs
DEST_PRED_DIR="${SCRATCH_ROOT}/Coffee_D2_GMM_PRED"  # generator outputs

...
#SBATCH -t 12:00:00
#SBATCH --job-name coffee-prep-d1-rdp-pred-gen
...
FINAL_OCEAN_DIR="/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Dataset/D2/EXTRA_KEYPOINTS/COFFEE_PREPERATION_D1_GMM_PRED"

# --- checkpoint (EDIT HERE to change) --------------------------------------
CKPT_PATH="${REPO_DIR}/logs/train_COFFEE_PREPERATION_D1_GOAL_SWAP_RDP_100demo/2026-07-05/17-20-37/checkpoints/periodic-epoch=epoch=74.ckpt"
if [ ! -f "${CKPT_PATH}" ]; then

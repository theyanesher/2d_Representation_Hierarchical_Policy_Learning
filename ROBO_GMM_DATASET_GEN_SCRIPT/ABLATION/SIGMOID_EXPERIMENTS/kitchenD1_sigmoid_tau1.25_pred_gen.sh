...
#SBATCH -t 12:00:00
#SBATCH --job-name kitchen-d1-sigmoid-pred-gen
...
# the smooth sigmoid profile, tau=1.25, instead of the linear/triangular
...
#      D2/ABLATIONS/SIGMOID_EXPERIMENTS_GMM_PREDICTIONS/KITCHEN_D1/
...
# scripts) — edit the path to switch checkpoints. NOTE: epoch 59 was
...
DEST_PRED_DIR="${SCRATCH_ROOT}/KITCHEN_D1_GMM_PRED_SIGMOID"   # generator outputs

...
#SBATCH -t 12:00:00
#SBATCH --job-name push-t-sigmoid-pred-gen
...
# the smooth sigmoid profile, tau=1.0, instead of the linear/triangular
...
#      D2/ABLATIONS/SIGMOID_EXPERIMENTS_GMM_PREDICTIONS/PushT/
...
FINAL_OCEAN_DIR="/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Dataset/D2/ABLATIONS/SIGMOID_EXPERIMENTS_GMM_PREDICTIONS/PushT"

# --- checkpoint (EDIT HERE to change) --------------------------------------
CKPT_PATH="${REPO_DIR}/logs/ABLATION/SIGMOID_EXPERIMENTS/PUSH_T_TASK/train_PushT_Task_GOAL_SWAP_SIGMOID_tau1.0/2026-07-30/20-32-07/checkpoints/periodic-epoch=epoch=74.ckpt"
if [ ! -f "${CKPT_PATH}" ]; then
...
DEST_PRED_DIR="${SCRATCH_ROOT}/PushT_GMM_PRED_SIGMOID"        # generator outputs

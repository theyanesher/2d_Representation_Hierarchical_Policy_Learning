...
#SBATCH -t 4:00:00
#SBATCH --job-name push-t-sigmoid-tau0.4-pred-gen
...
# the smooth sigmoid profile, tau=0.4, instead of the linear/triangular
...
#      D2/ABLATIONS/SIGMOID_EXPERIMENTS_GMM_PREDICTIONS/PushT_tau0.4/
...
FINAL_OCEAN_DIR="/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Dataset/D2/ABLATIONS/SIGMOID_EXPERIMENTS_GMM_PREDICTIONS/PushT_tau0.4"

# --- checkpoint (EDIT HERE to change) --------------------------------------
CKPT_PATH="${REPO_DIR}/logs/ABLATION/SIGMOID_EXPERIMENTS/PUSH_T_TASK/train_PushT_Task_GOAL_SWAP_SIGMOID_tau0.4/2026-08-06/13-24-16/checkpoints/periodic-epoch=epoch=89.ckpt"
if [ ! -f "${CKPT_PATH}" ]; then
...
DEST_PRED_DIR="${SCRATCH_ROOT}/PushT_GMM_PRED_SIGMOID_tau0.4"        # generator outputs

...
#SBATCH -t 4:00:00
#SBATCH --job-name kitchen-d1-sigmoid-tau2.5-pred-gen
...
# the smooth sigmoid profile, tau=2.5, instead of the linear/triangular
...
#      D2/ABLATIONS/SIGMOID_EXPERIMENTS_GMM_PREDICTIONS/KITCHEN_D1_tau2.5/
...
# scripts) — edit the path to switch checkpoints. NOTE: EDIT_ME placeholders must be filled once the tau2.5 high-level training finishes. (In the tau1.25 original, epoch 59 was
...
FINAL_OCEAN_DIR="/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Dataset/D2/ABLATIONS/SIGMOID_EXPERIMENTS_GMM_PREDICTIONS/KITCHEN_D1_tau2.5"

# --- checkpoint (EDIT HERE to change) --------------------------------------
CKPT_PATH="${REPO_DIR}/logs/ABLATION/SIGMOID_EXPERIMENTS/KITCHEN_D1/train_KITCHEN_D1_GOAL_SWAP_SIGMOID_tau2.5_100demo/2026-08-06/01-18-41/checkpoints/periodic-epoch=epoch=59.ckpt"
if [ ! -f "${CKPT_PATH}" ]; then
...
DEST_PRED_DIR="${SCRATCH_ROOT}/KITCHEN_D1_GMM_PRED_SIGMOID_tau2.5"   # generator outputs

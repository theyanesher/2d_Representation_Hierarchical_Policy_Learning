...
#SBATCH -t 12:00:00
#SBATCH --job-name kitchen-d1-noswap-pred-gen
...
#      D2/ABLATIONS/NO_GOAL_SWAPPING_EXPERIMENTS_GMM_PREDICTIONS/KITCHEN_D1/
...
FINAL_OCEAN_DIR="/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Dataset/D2/ABLATIONS/NO_GOAL_SWAPPING_EXPERIMENTS_GMM_PREDICTIONS/KITCHEN_D1"

# --- checkpoint (EDIT HERE to change) --------------------------------------
CKPT_PATH="${REPO_DIR}/logs/ABLATION/NO_GOAL_SWAPPING_EXPERIMENTS/KITCHEN_D1/train_KITCHEN_D1_NO_GOAL_SWAP_100demo/2026-07-30/20-32-02/checkpoints/periodic-epoch=epoch=74.ckpt"
if [ ! -f "${CKPT_PATH}" ]; then
...
DEST_PRED_DIR="${SCRATCH_ROOT}/KITCHEN_D1_GMM_PRED_NOSWAP"    # generator outputs

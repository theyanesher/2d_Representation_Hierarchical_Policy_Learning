#!/bin/bash
# INTERACTIVE variant of ../NO_GOAL_SWAPPING_EXPERIMENTS/pushT_noswap_pred_gen.sh
...
# Same checkpoint, key_suffix, and demo count (ALL 206) as the sbatch version.
...
# --- knobs -----------------------------------------------------------------
NUM_DEMOS="${NUM_DEMOS:-206}"      # ALL PushT demos: low-level PushT runs use 206
...
DEST_NPZ_DIR="${SCRATCH_ROOT}/PushT_Task_npz"

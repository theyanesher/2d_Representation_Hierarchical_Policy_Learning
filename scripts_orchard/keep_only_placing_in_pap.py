...
def remove_duplicate_reset_traj_folder(traj_path: str, target_path: str):
    ...
    # print(f"Copying traj {traj_path} to {new_path}, keeping {beg_t} to {last_idx} (out of {last_idx})")
...
if __name__ == "__main__":
    ...
    root_path = '/tmp/pick_and_place/top_cgn_1204/'
    target_path = "/tmp/pick_and_place/top_cgn_1204_place_only/"
    
    root_path = '/tmp/pick_and_place/inside_whole_cgn_1204/'
    target_path = "/tmp/pick_and_place/inside_whole_cgn_1204_place_only/"
    
    root_path = '/tmp/pick_and_place/inside_link_cgn_1204/'

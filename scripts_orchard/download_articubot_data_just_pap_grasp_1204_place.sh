...
mkdir -p /tmp/pick_and_place/top_cgn_grasp_grasp_only
sync_gcs_zip_folder gs://cmu-gpucloud-yufeiw2/top_cgn_grasp_grasp_only /tmp/pick_and_place/top_cgn_grasp_grasp_only

mkdir -p /tmp/pick_and_place/inside_link_cgn_grasp_grasp_only
sync_gcs_zip_folder gs://cmu-gpucloud-yufeiw2/inside_link_cgn_grasp_grasp_only /tmp/pick_and_place/inside_link_cgn_grasp_grasp_only

mkdir -p /tmp/pick_and_place/inside_whole_cgn_grasp_grasp_only
sync_gcs_zip_folder gs://cmu-gpucloud-yufeiw2/inside_whole_cgn_grasp_grasp_only /tmp/pick_and_place/inside_whole_cgn_grasp_grasp_only

mkdir -p /tmp/pick_and_place/top_cgn_1204_place_only
sync_gcs_zip_folder gs://cmu-gpucloud-yufeiw2/top_cgn_1204_place_only /tmp/pick_and_place/top_cgn_1204_place_only

mkdir -p /tmp/pick_and_place/inside_link_cgn_1204_place_only
sync_gcs_zip_folder gs://cmu-gpucloud-yufeiw2/inside_link_cgn_1204_place_only /tmp/pick_and_place/inside_link_cgn_1204_place_only

mkdir -p /tmp/pick_and_place/inside_whole_cgn_1204_place_only
sync_gcs_zip_folder gs://cmu-gpucloud-yufeiw2/inside_whole_cgn_1204_place_only /tmp/pick_and_place/inside_whole_cgn_1204_place_only

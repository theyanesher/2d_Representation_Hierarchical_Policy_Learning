...
#SBATCH --job-name mug-cleanup-d1-weighted-cross-attention
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=groot_GMM_Weighted_Cross_Attention_MugCleanup_D1 \
    name=groot_GMM_Weighted_Cross_Attention_MugCleanup_D1 \

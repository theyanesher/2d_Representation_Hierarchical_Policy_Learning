...
#SBATCH --job-name hammer-cleanup-d1-goal-gripper-absolute
...
# Absolute-action variant of hammercleanupD1_goal_gripper_cond.sh.
# Supervises on  absolute[t] = state[t] ⊕ action/hybrid[t]  (commanded target
# pose for OSC_POSE in absolute mode).
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=hammercleanup_D1_goal_gripper_DIT_absolute \
    name=hammercleanup_D1_goal_gripper_DIT_absolute \

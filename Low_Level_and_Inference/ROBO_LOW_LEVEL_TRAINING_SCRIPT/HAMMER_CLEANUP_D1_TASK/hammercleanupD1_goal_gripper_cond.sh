...
#SBATCH --job-name hammer-cleanup-d1-goal-gripper
...
# distribution. Stages the dataset onto the compute node's local scratch
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=hammercleanup_D1_goal_gripper_DIT \
    name=hammercleanup_D1_goal_gripper_DIT \

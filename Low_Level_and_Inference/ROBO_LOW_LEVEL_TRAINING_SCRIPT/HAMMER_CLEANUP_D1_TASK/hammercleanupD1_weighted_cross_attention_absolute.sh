...
#SBATCH --job-name hammer-cleanup-d1-weighted-cross-attention-absolute
...
# Absolute-action variant of hammercleanupD1_weighted_cross_attention.sh.
...
DEST_DATA_DIR="${SCRATCH_ROOT}/HAMMER_CLEANUP_D1_Low_Level_absolute"
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=groot_GMM_Weighted_Cross_Attention_HammerCleanup_D1_absolute \
    name=groot_GMM_Weighted_Cross_Attention_HammerCleanup_D1_absolute \

...
#SBATCH --job-name hammer-cleanup-d1-weighted-cross-attention
...
# Train flow-matching DiT low-level policy on HAMMER_CLEANUP_D1 with GMM weighted
...
DEST_DATA_DIR="${SCRATCH_ROOT}/HAMMER_CLEANUP_D1_Low_Level"
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=groot_GMM_Weighted_Cross_Attention_HammerCleanup_D1 \
    name=groot_GMM_Weighted_Cross_Attention_HammerCleanup_D1 \
    training.checkpoint_every=5 \
    training.resume=true \
    +training.resume_ckpt_path=/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Code/Low_Level_Policy/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/outputs/2026.05.11/19.12.39_groot_GMM_Weighted_Cross_Attention_HammerCleanup_D1_hammercleanup_D1_gmm_goal/checkpoints/epoch_60.ckpt \

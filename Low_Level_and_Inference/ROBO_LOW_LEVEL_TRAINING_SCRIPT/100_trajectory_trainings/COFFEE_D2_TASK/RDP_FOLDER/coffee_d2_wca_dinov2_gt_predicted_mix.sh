...
#SBATCH --job-name coffee-d2-wca-100demo-dinov2-rdp-gtmix
...
# RDP GT/predicted goal-MIX run on Coffee_D2: per TRAIN sample, Bernoulli(gt_mix_p)
# picks the ground-truth RDP goal set; otherwise the RDP high-level prediction:
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_Coffee_D2_RDP_GTMIX_p${GT_MIX_P} \
    name=groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_Coffee_D2_RDP_GTMIX_p${GT_MIX_P} \

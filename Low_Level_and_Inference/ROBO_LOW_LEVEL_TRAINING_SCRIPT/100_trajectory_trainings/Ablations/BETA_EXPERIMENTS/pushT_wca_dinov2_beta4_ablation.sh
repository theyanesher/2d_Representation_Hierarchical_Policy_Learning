...
#SBATCH --job-name push-t-wca-beta4-ablation
...
# BETA ABLATION on PushT_Task GOAL_SWAP (DINOv2, serial WCA, GT-mix) — BETA=4 variant.
#
...
#   sbatch this_script.sh                       # top-2500, alpha=1.0, beta=4
...
# --- ablation knobs -------------------------------------------------------
BETA="${BETA:-4}"              # wca_beta: prior temperature on log(w) (1.0 = original)

...
#SBATCH --job-name kitchen-d1-wca-alpha0.01-ablation
...
# ALPHA ABLATION on KITCHEN_D1 (100 demos, DINOv2, serial WCA) — ALPHA=0.01 variant.
#
# Same treatment as kitchenD1_wca_dinov2_alpha0.1_ablation.sh, one knob
# changed: ALPHA defaults to 0.01. Per the interpretation anchors
...
#   sbatch this_script.sh                       # top-2500, alpha=0.01

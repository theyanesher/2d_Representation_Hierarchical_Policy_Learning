...
#SBATCH -t 10:00:00
#SBATCH --job-name push-t-wca-sigmoid-tau0.4-gtmix
...
#      which trained at bs64 on V100-32.
#
...
PRED_SRC_DIR="/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Dataset/D2/ABLATIONS/SIGMOID_EXPERIMENTS_GMM_PREDICTIONS/PushT_tau0.4"
...
RUN_NAME="groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_PushT_Task_SIGMOID_tau0.4_GTMIX_p${GT_MIX_P}_top6_bs${BATCH_SIZE}"

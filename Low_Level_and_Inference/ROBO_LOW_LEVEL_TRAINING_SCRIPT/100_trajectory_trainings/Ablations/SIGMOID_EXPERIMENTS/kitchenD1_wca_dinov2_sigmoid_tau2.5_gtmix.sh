...
#SBATCH -p ROBO
#SBATCH --cpus-per-task=12    # 12 CPU cores (dataloader workers etc.)
#SBATCH --gpus=h100:1 #GPU specification. H100
#SBATCH -t 16:00:00
#SBATCH --job-name kitchen-d1-wca-sigmoid-tau2.5-gtmix
...
#      never loaded.
#   2. Runs on a ROBO H100. BATCH_SIZE stays 64 (NOT 128) so results are
#      directly comparable to the tau1.25/tau1.0 sigmoid runs, which trained
#      at bs64 on V100-32.
#
...
RUN_NAME="groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_Kitchen_D1_SIGMOID_tau2.5_GTMIX_p${GT_MIX_P}_top6_bs${BATCH_SIZE}"
...
PRED_SRC_DIR="/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Dataset/D2/ABLATIONS/SIGMOID_EXPERIMENTS_GMM_PREDICTIONS/KITCHEN_D1_tau2.5"

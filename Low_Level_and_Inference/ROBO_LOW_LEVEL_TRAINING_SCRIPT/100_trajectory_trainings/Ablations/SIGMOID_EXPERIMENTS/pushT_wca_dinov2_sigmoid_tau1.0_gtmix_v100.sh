...
# NOTE: the completed 2026.08.02 run used the untagged name (no _tau1.0).
RUN_NAME="groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_PushT_Task_SIGMOID_tau1.0_GTMIX_p${GT_MIX_P}_top6_bs${BATCH_SIZE}"

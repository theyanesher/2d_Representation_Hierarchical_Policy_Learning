...
#SBATCH -t 16:00:00
#SBATCH --job-name kitchen-d1-wca-sigmoid-tau0.5-gtmix
...
RUN_NAME="groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_Kitchen_D1_SIGMOID_tau0.5_GTMIX_p${GT_MIX_P}_top6_bs${BATCH_SIZE}"
...
PRED_SRC_DIR="/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Dataset/D2/ABLATIONS/SIGMOID_EXPERIMENTS_GMM_PREDICTIONS/KITCHEN_D1_tau0.5"

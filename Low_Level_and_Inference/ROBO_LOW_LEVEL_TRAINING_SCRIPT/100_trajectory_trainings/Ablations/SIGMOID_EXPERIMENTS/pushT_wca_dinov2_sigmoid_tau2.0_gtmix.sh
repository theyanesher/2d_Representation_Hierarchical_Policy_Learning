...
#SBATCH -t 10:00:00
#SBATCH --job-name push-t-wca-sigmoid-tau2.0-gtmix
...
PRED_SRC_DIR="/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Dataset/D2/ABLATIONS/SIGMOID_EXPERIMENTS_GMM_PREDICTIONS/PushT_tau2.0"
...
RUN_NAME="groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_PushT_Task_SIGMOID_tau2.0_GTMIX_p${GT_MIX_P}_top6_bs${BATCH_SIZE}"

...
#SBATCH --job-name push-t-wca-alpha0.001-ablation
...
# ALPHA ABLATION on PushT_Task GOAL_SWAP (DINOv2, serial WCA, GT-mix) — ALPHA=0.001 variant.
#
# Same treatment as pushT_wca_dinov2_alpha0.1_ablation.sh, one knob changed:
# ALPHA defaults to 0.001 — even deeper into the PRIOR-ONLY regime than 0.01. Per the interpretation anchors (content-logit
...
#   sbatch this_script.sh                       # top-2500, alpha=0.001, gtmix 0.5

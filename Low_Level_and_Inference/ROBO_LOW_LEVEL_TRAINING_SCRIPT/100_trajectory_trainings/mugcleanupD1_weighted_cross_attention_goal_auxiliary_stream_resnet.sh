...
#SBATCH --job-name mug-d1-wca-aux-stream-100demo-resnet
...
# + ResNet-18 visual encoder. Uses the first NUM_DEMOS demos.
# NUM_DEMOS defaults to 100 — override with `NUM_DEMOS=200 sbatch …`.
#
# Param cost: ~3-4× the cross-attn stack of the baseline DiT. With ResNet-18
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=groot_GMM_WCA_GoalAuxStream_${NUM_DEMOS}demo_resnet_MugCleanup_D1 \
    name=groot_GMM_WCA_GoalAuxStream_${NUM_DEMOS}demo_resnet_MugCleanup_D1 \

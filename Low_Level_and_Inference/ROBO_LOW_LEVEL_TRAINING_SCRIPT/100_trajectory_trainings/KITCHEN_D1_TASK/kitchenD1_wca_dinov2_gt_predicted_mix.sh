...
#SBATCH --job-name kitchen-d1-wca-100demo-dinov2-gtmix
...
# 100-demo GT/predicted goal-MIX run on KITCHEN_D1.
#
# Identical to kitchenD1_weighted_cross_attention_dinov2.sh EXCEPT it uses the
# additive task `kitchen_D1_gmm_goal_gt_mix`, whose dataset subclass
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_Kitchen_D1_GTMIX_p${GT_MIX_P} \
    name=groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_Kitchen_D1_GTMIX_p${GT_MIX_P} \

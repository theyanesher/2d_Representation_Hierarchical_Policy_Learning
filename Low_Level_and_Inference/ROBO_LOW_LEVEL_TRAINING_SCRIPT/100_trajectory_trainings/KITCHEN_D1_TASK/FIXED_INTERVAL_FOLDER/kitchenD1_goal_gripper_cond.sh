...
#SBATCH -t 20:00:00 # 20-hour budget
#SBATCH --job-name kitchen-d1-goal-gripper-fixed-interval-100demo-dinov2
#SBATCH -o /ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Code/Low_Level_Policy/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/ROBO_LOW_LEVEL_TRAINING_SCRIPT/100_trajectory_trainings/KITCHEN_D1_TASK/FIXED_INTERVAL_FOLDER/logs/job_%j.out
#SBATCH -e /ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Code/Low_Level_Policy/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/ROBO_LOW_LEVEL_TRAINING_SCRIPT/100_trajectory_trainings/KITCHEN_D1_TASK/FIXED_INTERVAL_FOLDER/logs/job_%j.err
#SBATCH --mail-type=END
#SBATCH --mail-user=pbhowal@andrew.cmu.edu

# 100-demo goal_gripper baseline on KITCHEN_D1, conditioned on fixed-interval
# goals (obs/goal_gripper_pts_fixed_interval) instead of the default goal_gripper_pts.
#
# Same pipeline as the default kitchenD1_goal_gripper_cond.sh, plus one
...
EXTRA_GOALS_DIR="/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Dataset/D2/EXTRA_KEYPOINTS/KITCHEN_D1"
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=kitchen_D1_goal_gripper_${GOAL_SOURCE}_${NUM_DEMOS}demo_dinov2_DIT \
    name=kitchen_D1_goal_gripper_${GOAL_SOURCE}_${NUM_DEMOS}demo_dinov2_DIT \

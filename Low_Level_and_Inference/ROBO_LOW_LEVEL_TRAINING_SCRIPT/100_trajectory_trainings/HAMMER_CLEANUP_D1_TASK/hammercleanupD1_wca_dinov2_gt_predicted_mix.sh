...
#SBATCH --job-name hammer-cleanup-d1-wca-100demo-dinov2-gtmix-goalswap
...
# whose GMM annotations come from the NEW GOAL_SWAP high-level model
# (HAMMER_CLEANUP_D1_GOAL_SWAP, generated 2026-07-22 from the
# train_HammerCleanup_D1_GOAL_SWAP_100demo epoch=59 best-val checkpoint via
# ROBO_GMM_DATASET_GEN_SCRIPT/hammercleanD1_GOAL_SWAP.sh).
#
...
#   NUM_DEMOS=200 sbatch this_script.sh   (needs the GOAL_SWAP gen job re-run
#                                          with NUM_DEMOS>=200 first)
# To train against the OLD (GHOST epoch-59 model) GMM annotations instead:
#   GMM_H5_DIR=.../LOW_LEVEL_WITH_GMM_DATASET_GROOT_STYLE_DATASET/D2/HAMMER_CLEANUP_D1 sbatch this_script.sh
...
# --- paths ---------------------------------------------------------------
SRC_DATA_DIR="${GMM_H5_DIR:-/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/LOW_LEVEL_WITH_GMM_DATASET_GROOT_STYLE_DATASET/D2/HAMMER_CLEANUP_D1_GOAL_SWAP}"
...
DEST_DATA_DIR="${SCRATCH_ROOT}/Hammer_Cleanup_D1_GoalSwap_Low_Level_${NUM_DEMOS}demo"
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_Hammer_Cleanup_D1_GOALSWAP_GTMIX_p${GT_MIX_P} \
    name=groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_Hammer_Cleanup_D1_GOALSWAP_GTMIX_p${GT_MIX_P} \

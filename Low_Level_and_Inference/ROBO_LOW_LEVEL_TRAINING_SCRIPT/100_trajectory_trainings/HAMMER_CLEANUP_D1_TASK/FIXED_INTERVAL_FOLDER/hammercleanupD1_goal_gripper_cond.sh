...
EXTRA_GOALS_DIR="/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Dataset/D2/EXTRA_KEYPOINTS/HAMMER_CLEANUP_D1"
NO_GMM_H5_DIR="/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/LOW_LEVEL_WITH_GMM_DATASET_GROOT_STYLE_DATASET/D2/HAMMER_CLEANUP_D1"
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=hammercleanup_D1_goal_gripper_${GOAL_SOURCE}_${NUM_DEMOS}demo_dinov2_DIT \
    name=hammercleanup_D1_goal_gripper_${GOAL_SOURCE}_${NUM_DEMOS}demo_dinov2_DIT \

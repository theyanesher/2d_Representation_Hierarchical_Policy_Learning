...
#SBATCH --job-name hammer-d1-wca-100demo-dinov2-rdp-onlygt
#SBATCH -o /ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Code/Low_Level_Policy/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/ROBO_LOW_LEVEL_TRAINING_SCRIPT/100_trajectory_trainings/HAMMER_CLEANUP_D1_TASK/RDP_FOLDER/logs/job_%j.out
...
# RDP ONLY-GT run on HAMMER_CLEANUP_D1 (gt_mix_p=1.0 -> every TRAIN sample uses
...
#
# The GT goals come from the EXTRA_KEYPOINTS npz tree (goal_gripper_pcd_rdp) so
...
GT_SRC_DIR="/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Dataset/D2/EXTRA_KEYPOINTS/HAMMER_CLEANUP_D1"
...
DEST_PRED_DIR="${SCRATCH_ROOT}/Hammer_Cleanup_D1_GMM_PRED_${NUM_DEMOS}demo"
DEST_GT_DIR="${SCRATCH_ROOT}/Hammer_Cleanup_D1_rdp_goals_${NUM_DEMOS}demo"
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_HammerCleanup_D1_RDP_ONLY_GT \
    name=groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_HammerCleanup_D1_RDP_ONLY_GT \

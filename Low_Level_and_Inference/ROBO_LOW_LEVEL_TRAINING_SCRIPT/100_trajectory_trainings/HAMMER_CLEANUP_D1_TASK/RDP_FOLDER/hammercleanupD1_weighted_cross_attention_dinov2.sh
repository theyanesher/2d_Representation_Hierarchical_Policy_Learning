...
#SBATCH --job-name hammer-d1-wca-100demo-dinov2-rdp
...
# RDP version of the HAMMER_CLEANUP_D1 GMM weighted-cross-attention baseline
# (non-RDP baseline: ROBO_LOW_LEVEL_TRAINING_SCRIPT/HAMMER_CLEANUP_D1_TASK/
# hammercleanupD1_weighted_cross_attention.sh).
#
# Same flow-matching DiT + DINOv2 + WCA setup, but the GMM conditioning
...
# (EXTRA_KEYPOINTS/HAMMER_CLEANUP_D1_GMM_PRED, keys gmm_all_goals_rdp /
...
pixi run python diffusion_policy/train.py \
    ...
    task=MimicGen_Tasks/hammercleanup_D1_gmm_goal \
    ...
    logging.name=groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_HammerCleanup_D1_RDP \
    name=groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_HammerCleanup_D1_RDP \

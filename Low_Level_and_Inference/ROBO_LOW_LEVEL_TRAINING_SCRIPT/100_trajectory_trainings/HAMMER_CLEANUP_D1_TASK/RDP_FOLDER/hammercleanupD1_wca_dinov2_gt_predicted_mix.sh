...
#SBATCH --job-name hammer-d1-wca-100demo-dinov2-rdp-gtmix
...
# RDP GT/predicted goal-MIX run on HAMMER_CLEANUP_D1: per TRAIN sample,
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_HammerCleanup_D1_RDP_GTMIX_p${GT_MIX_P} \
    name=groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_HammerCleanup_D1_RDP_GTMIX_p${GT_MIX_P} \

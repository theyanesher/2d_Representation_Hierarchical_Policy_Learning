...
#SBATCH --job-name mug-d1-wca-adaln-mod-100demo-resnet
...
# residual) + ResNet-18 visual encoder. Uses the first NUM_DEMOS demos
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=groot_GMM_WCA_GoalAdaLNMod_${NUM_DEMOS}demo_resnet_MugCleanup_D1 \
    name=groot_GMM_WCA_GoalAdaLNMod_${NUM_DEMOS}demo_resnet_MugCleanup_D1 \

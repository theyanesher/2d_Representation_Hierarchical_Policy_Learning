...
#SBATCH --job-name kitchen-d1-c1-0.1
...
# ===========================================================================
# APPROACH 2 on KITCHEN_D1  —  c1 = 0.1
# ===========================================================================
...
#     fm_loss  ~ 1.38     |grad_fm  -> shared trunk| ~ 1.32
#     gmm_loss ~ 8.15     |grad_gmm -> shared trunk| ~ 3.97  (per unit c1)
#   c1 = 0.169 equalises the two loss magnitudes
#   c1 = 0.333 equalises the gradient each delivers to the shared trunk
#   c1 = 0.1   -> auxiliary gradient is ~30% of the flow gradient: a real
...
#
# Kitchen_D1 has 1000 converted h5 files, so NUM_DEMOS has plenty of headroom.
#
...
DEST_DATA_DIR="${SCRATCH_ROOT}/Kitchen_D1_Approach2_${NUM_DEMOS}demo"
...
RUN_NAME="kitchen_D1_APPROACH2_c1_${C1}_${NUM_DEMOS}demo"

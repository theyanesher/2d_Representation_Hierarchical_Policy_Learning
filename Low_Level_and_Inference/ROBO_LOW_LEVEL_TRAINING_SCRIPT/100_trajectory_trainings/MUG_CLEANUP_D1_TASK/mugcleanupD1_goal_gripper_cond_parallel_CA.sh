...
#SBATCH --job-name mug-d1-goal-gripper-parallel-ca-100demo-dinov2
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=mug_cleanup_D1_goal_gripper_parallel_CA_${NUM_DEMOS}demo_dinov2_DIT \
    name=mug_cleanup_D1_goal_gripper_parallel_CA_${NUM_DEMOS}demo_dinov2_DIT \

...
#SBATCH --job-name mug-d1-goal-gripper-fixed-interval-100demo-dinov2
#SBATCH -o /ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Code/Low_Level_Policy/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/ROBO_LOW_LEVEL_TRAINING_SCRIPT/100_trajectory_trainings/MUG_CLEANUP_D1_TASK/FIXED_INTERVAL_FOLDER/logs/job_%j.out
...
# 100-demo goal_gripper baseline on Mug_Cleanup_D1, conditioned on fixed-interval

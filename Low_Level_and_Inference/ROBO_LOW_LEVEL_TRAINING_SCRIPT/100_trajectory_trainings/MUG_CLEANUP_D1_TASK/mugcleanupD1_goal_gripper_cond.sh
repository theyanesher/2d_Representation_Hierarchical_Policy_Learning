...
#SBATCH --job-name mug-d1-goal-gripper-100demo-dinov2
...
# 100-demo version of the non-GMM goal_gripper baseline.
#
# Train flow-matching DiT low-level policy on Mug_Cleanup_D1 conditioned on the
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=mug_cleanup_D1_goal_gripper_${NUM_DEMOS}demo_dinov2_DIT \
    name=mug_cleanup_D1_goal_gripper_${NUM_DEMOS}demo_dinov2_DIT \

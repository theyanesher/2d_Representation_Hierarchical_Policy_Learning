...
#SBATCH --job-name mug-d1-wca-100demo-dinov2-rdp
...
# RDP version of the Mug_Cleanup_D1 GMM weighted-cross-attention baseline.
#
# Same flow-matching DiT + DINOv2 + WCA setup as
# ../mugcleanupD1_weighted_cross_attention_dinov2.sh, but the GMM conditioning
...
# (EXTRA_KEYPOINTS/Mug_Cleanup_D1_GMM_PRED, keys gmm_all_goals_rdp /
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_MugCleanup_D1_RDP \
    name=groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_MugCleanup_D1_RDP \

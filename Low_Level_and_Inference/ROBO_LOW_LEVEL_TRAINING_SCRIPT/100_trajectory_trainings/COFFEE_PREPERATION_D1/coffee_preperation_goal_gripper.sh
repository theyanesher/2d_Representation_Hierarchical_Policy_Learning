...
#SBATCH --job-name coffee-prep-d1-goal-gripper-100demo-dinov2
...
# 100-demo version of the non-GMM goal_gripper baseline, on COFFEE_PREPERATION_D1.
#
# Train flow-matching DiT low-level policy on COFFEE_PREPERATION_D1 conditioned on
...
# Override at submission time, or set RESUME_CKPT="" to train from scratch:
#   RESUME_CKPT="" sbatch this_script.sh
RESUME_CKPT="${RESUME_CKPT:-/ocean/projects/cis240052p/pbhowal/2d_Representation_Hierarchical_Policy_Learning/MimicGen_Uncertainty_Code/Low_Level_Policy/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/outputs/2026.06.06/10.27.55_coffee_preperation_D1_goal_gripper_100demo_dinov2_DIT_coffee_preperation_goal_gripper/checkpoints/epoch_30.ckpt}"
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=coffee_preperation_D1_goal_gripper_${NUM_DEMOS}demo_dinov2_DIT \
    name=coffee_preperation_D1_goal_gripper_${NUM_DEMOS}demo_dinov2_DIT \

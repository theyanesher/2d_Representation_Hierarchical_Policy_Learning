...
#SBATCH --job-name coffee-prep-d1-goal-gripper-rdp-gripper-100demo-dinov2
...
# 100-demo goal_gripper baseline on COFFEE_PREPERATION_D1, conditioned on RDP-gripper

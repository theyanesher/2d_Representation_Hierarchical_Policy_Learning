...
#SBATCH --job-name coffee-prep-d1-wca-rope-100demo-dinov2-gtmix
...
#
# The GOAL PATHWAY IS UNTOUCHED: goals still arrive via weighted cross-attention
# over the top-6 GMM candidates, exactly as in the baseline. Only the visual
# memory the DiT cross-attends to changes.
#
...
pixi run python diffusion_policy/train.py \
    ...
    logging.name=groot_GMM_WCA_ROPE_${NUM_DEMOS}demo_dinov2_Coffee_Preperation_D1_GTMIX_p${GT_MIX_P} \
    name=groot_GMM_WCA_ROPE_${NUM_DEMOS}demo_dinov2_Coffee_Preperation_D1_GTMIX_p${GT_MIX_P} \

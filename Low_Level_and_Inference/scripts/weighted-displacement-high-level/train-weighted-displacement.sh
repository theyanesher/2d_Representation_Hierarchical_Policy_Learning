...
pixi run torchrun --standalone --nproc_per_node=2 weighted_displacement_model/train_ddp_weighted_displacement.py --batch_size 50 \
    --num_epochs 100 \
    --exp_path weighted_displacement_model/exps \
    --num_train_objects only_41510 \
    --dataset_prefix data/dp3_demo \
    --use_all_data \
    --exp_name _test_cleaned_code

...
def process_h5_file(h5_path: Path, viz_dir: Path, heatmap_dir: Path,
                    sigma_gaussian: float, sigma_ghost: float, timestep: int = None):
    ...
    with h5py.File(h5_path, "r") as src:
        ...
        for t in range(num_frames):
            ...
            goal_pcd = src['obs/goal_gripper_pcd'][t]  # (10,)
...
def main():
    ...
    if input_path.is_dir():
        ...
        for h5_path in h5_files:
            process_h5_file(h5_path, viz_dir, heatmap_dir, args.sigma_gaussian, args.sigma_ghost, args.timestep)
    elif input_path.is_file():
        process_h5_file(input_path, viz_dir, heatmap_dir, args.sigma_gaussian, args.sigma_ghost, args.timestep)
    else:

...
#SBATCH --job-name coffee-prep-d1-approach2-vlm
#SBATCH -o /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-approach2-vlm_job_%j.out
#SBATCH -e /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-approach2-vlm_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 (GMM-as-auxiliary-loss) on COFFEE_PREPERATION_D1  —  goal_source=vlm, c1=0.1
# ===========================================================================
...
#
# This variant supervises the GMM head with the vlm keypoint field
# (VLM-predicted subgoal keypoints, EXTRA_KEYPOINTS_vlm_v3 tree,
# goal_gripper_pcd_vlm) instead of the ground-truth goal_gripper_pts —
# selected via +task.dataset.goal_source. c1=0.1 is the established
# "start here" auxiliary-loss weight for Approach 2 (see the sibling
# *_c1_0.1.sh scripts in ROBO_LOW_LEVEL_TRAINING_SCRIPT/100_trajectory_trainings/Approach2/
...
#      +task.dataset.goal_source=vlm and policy.aux_gmm_loss_weight=0.1.
#
...
EXTRA_GOALS_DIR="/jet/home/eswaramo/data/D2/EXTRA_KEYPOINTS/EXTRA_KEYPOINTS_vlm_v3/COFFEE_PREPERATION_D1"

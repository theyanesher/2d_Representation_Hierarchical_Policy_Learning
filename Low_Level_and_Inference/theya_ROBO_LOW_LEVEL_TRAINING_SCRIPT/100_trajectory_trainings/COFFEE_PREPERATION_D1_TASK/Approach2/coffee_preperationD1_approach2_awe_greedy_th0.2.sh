...
#SBATCH --job-name coffee-prep-d1-approach2-awe-greedy-th0.2
#SBATCH -o /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-approach2-awe-greedy-th0.2_job_%j.out
#SBATCH -e /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-approach2-awe-greedy-th0.2_job_%j.err
...
# EXTRA_KEYPOINTS_awe-greedy-th0.2 tree instead of the combined
...
#      --inject_extra_goals) from the EXTRA_KEYPOINTS_awe-greedy-th0.2 npz
...
#
# EXTRA_KEYPOINTS_awe-greedy-th0.2/COFFEE_PREPERATION_D1 has been verified to
...
EXTRA_GOALS_DIR="/jet/home/eswaramo/data/D2/EXTRA_KEYPOINTS/EXTRA_KEYPOINTS_awe-greedy-th0.2/COFFEE_PREPERATION_D1"
...
echo "[inject] ensuring obs/goal_gripper_pts_awe exists in staged demos (from EXTRA_KEYPOINTS_awe-greedy-th0.2)"
(
    cd "${REPO_DIR}"
    USE_TF=0 \
    GIT_LFS_SKIP_SMUDGE=1 \

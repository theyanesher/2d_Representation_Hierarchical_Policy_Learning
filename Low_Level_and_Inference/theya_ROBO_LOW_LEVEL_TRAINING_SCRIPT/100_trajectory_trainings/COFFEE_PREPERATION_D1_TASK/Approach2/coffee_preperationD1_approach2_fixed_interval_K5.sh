...
#SBATCH --job-name coffee-prep-d1-approach2-fixed-interval-K5
#SBATCH -o /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-approach2-fixed-interval-K5_job_%j.out
#SBATCH -e /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-approach2-fixed-interval-K5_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 (GMM-as-auxiliary-loss) on COFFEE_PREPERATION_D1  —  goal_source=fixed_interval, K=5 extra keypoints, c1=0.1
# ===========================================================================
...
# (goal_gripper_pcd_fixed_interval) sourced from the K=5 tree of the
# fixed_interval keypoint-count sweep
# (EXTRA_KEYPOINTS_fixed_interval_K5/COFFEE_PREPERATION_D1) -- fixed_interval keypoints
# spaced K frames apart along the trajectory, K=5 being the densest setting
...
#      the EXTRA_KEYPOINTS_fixed_interval_K5 npz tree into the staged,
#      node-local copy.
...
#
# EXTRA_KEYPOINTS_fixed_interval_K5/COFFEE_PREPERATION_D1 covers demo_0..demo_99

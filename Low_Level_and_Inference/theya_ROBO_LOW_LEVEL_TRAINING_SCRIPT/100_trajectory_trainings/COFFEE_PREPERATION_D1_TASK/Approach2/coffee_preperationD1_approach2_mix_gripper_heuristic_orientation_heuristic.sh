...
#SBATCH --job-name coffee-prep-d1-approach2-mix_gripper_heuristic_orientation_heuristic
#SBATCH -o /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-approach2-mix_gripper_heuristic_orientation_heuristic_job_%j.out
#SBATCH -e /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-approach2-mix_gripper_heuristic_orientation_heuristic_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 (GMM-as-auxiliary-loss) on COFFEE_PREPERATION_D1  —  goal_source=mix_gripper_heuristic_orientation_heuristic, c1=0.1
# ===========================================================================
...
EXTRA_GOALS_DIR="/jet/home/eswaramo/data/D2/EXTRA_KEYPOINTS/EXTRA_KEYPOINTS_bspline_bspline_greville_awe_gripper_heuristic_orientation_heuristic_uvd_mix_bspline_bspline_greville_mix_gripper_heuristic_orientation_heuristic/COFFEE_PREPERATION_D1"
...
DEST_DATA_DIR="${SCRATCH_ROOT}/Coffee_Preperation_D1_Approach2_${GOAL_SOURCE}_${NUM_DEMOS}demo"
...
RUN_NAME="coffee_preperation_D1_APPROACH2_${GOAL_SOURCE}_c1_${C1}_${NUM_DEMOS}demo_dinov2_DIT"

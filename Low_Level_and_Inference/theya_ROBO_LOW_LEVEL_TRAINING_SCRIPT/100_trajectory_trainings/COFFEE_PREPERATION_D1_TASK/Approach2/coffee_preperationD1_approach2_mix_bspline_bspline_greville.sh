...
#SBATCH --job-name coffee-prep-d1-approach2-mix_bspline_bspline_greville
#SBATCH -o /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-approach2-mix_bspline_bspline_greville_job_%j.out
#SBATCH -e /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-approach2-mix_bspline_bspline_greville_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 (GMM-as-auxiliary-loss) on COFFEE_PREPERATION_D1  —  goal_source=mix_bspline_bspline_greville, c1=0.1
# ===========================================================================
...
#
# This variant supervises the GMM head with the mix_bspline_bspline_greville keypoint field
# from the EXTRA_KEYPOINTS tree (goal_gripper_pcd_mix_bspline_bspline_greville) instead of
...
#      +task.dataset.goal_source=mix_bspline_bspline_greville and policy.aux_gmm_loss_weight=0.1.
#
...
GOAL_SOURCE="mix_bspline_bspline_greville"
C1=0.1

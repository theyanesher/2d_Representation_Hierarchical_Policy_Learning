...
#SBATCH --job-name coffee-prep-d1-approach2-awe-dp-th0.35
#SBATCH -o /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-approach2-awe-dp-th0.35_job_%j.out
#SBATCH -e /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-approach2-awe-dp-th0.35_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 (GMM-as-auxiliary-loss) on COFFEE_PREPERATION_D1  —  goal_source=awe (DP subgoals, err_th=0.35), c1=0.1
# ===========================================================================
...
# EXTRA_KEYPOINTS_awe-dp-th0.35 tree instead of the combined
...
# threshold 0.35 (tighter threshold -> more, closer-spaced keypoints) —
...
#      --inject_extra_goals) from the EXTRA_KEYPOINTS_awe-dp-th0.35 npz tree
...
#
# EXTRA_KEYPOINTS_awe-dp-th0.35/COFFEE_PREPERATION_D1 has been verified to
...
EXTRA_GOALS_DIR="/jet/home/eswaramo/data/D2/EXTRA_KEYPOINTS/EXTRA_KEYPOINTS_awe-dp-th0.35/COFFEE_PREPERATION_D1"
...
echo "[inject] ensuring obs/goal_gripper_pts_awe exists in staged demos (from EXTRA_KEYPOINTS_awe-dp-th0.35)"
(
    cd "${REPO_DIR}"
    USE_TF=0 \
    GIT_LFS_SKIP_SMUDGE=1 \

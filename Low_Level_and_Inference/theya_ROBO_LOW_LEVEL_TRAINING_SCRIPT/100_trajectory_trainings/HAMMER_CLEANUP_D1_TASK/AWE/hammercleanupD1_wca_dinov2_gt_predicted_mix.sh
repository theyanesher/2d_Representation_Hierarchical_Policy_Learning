...
#SBATCH --job-name hammer-cleanup-d1-AWE-wca-100demo-dinov2-gtmix-goalswap
#SBATCH -o /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/hammer-cleanup-d1-AWE-wca-100demo-dinov2-gtmix-goalswap_job_%j.out
#SBATCH -e /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/hammer-cleanup-d1-AWE-wca-100demo-dinov2-gtmix-goalswap_job_%j.err
...
# whose GMM annotations come from the AWE-subgoal-trained high-level model
# (HAMMER_CLEANUP_D1_AWE, trained via
# logs/train_HammerCleanup_D1_AWE/2026-08-08/18-51-00,
...
# /data/theya/D1/HAMMER_CLEANUP_D1_AWE_SUBGOALS_100demo via
...
#   NUM_DEMOS=200 sbatch this_script.sh   (needs the AWE GMM dataset
...
# --- paths ---------------------------------------------------------------
SRC_DATA_DIR="${GMM_H5_DIR:-/jet/home/eswaramo/data/D2/GMM_preds/AWE/HAMMER_CLEANUP_D1_AWE_SUBGOALS_100demo}"

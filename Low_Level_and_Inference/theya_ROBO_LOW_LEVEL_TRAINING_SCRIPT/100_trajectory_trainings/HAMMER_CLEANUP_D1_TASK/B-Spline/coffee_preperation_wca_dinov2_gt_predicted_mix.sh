...
#SBATCH -t 16:00:00 # 16-hour budget
#SBATCH --job-name coffee-prep-d1-wca-100demo-dinov2-bspline-gtmix
#SBATCH -o /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-BSpline-wca-100demo-dinov2-gtmix-goalswap_job_%j.out
#SBATCH -e /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/coffee-prep-d1-BSpline-wca-100demo-dinov2-gtmix-goalswap_job_%j.err
...
echo "[gt_mix] gt_mix_p=${GT_MIX_P}  (P of using ground-truth BSpline goals per sample)"
...
PRED_SRC_DIR="/jet/home/eswaramo/data/D2/EXTRA_KEYPOINTS/COFFEE_PREPERATION_D1_BSPLINE_GMM_PRED"
GT_SRC_DIR="/jet/home/eswaramo/data/D2/EXTRA_KEYPOINTS/COFFEE_PREPERATION_D1"
...
DEST_GT_DIR="${SCRATCH_ROOT}/Coffee_Preperation_D1_bspline_goals_${NUM_DEMOS}demo"
...
pixi run python diffusion_policy/train.py \
    ...
    +task.dataset.gmm_pred_key_suffix=bspline \
    +task.dataset.gt_goal_npz_dir="${DEST_GT_DIR}" \
    +task.dataset.gt_goal_npz_key=goal_gripper_pcd_bspline \
    ...
    logging.name=groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_Coffee_Preperation_D1_BSPLINE_GTMIX_p${GT_MIX_P} \
    name=groot_GMM_WCA_${NUM_DEMOS}demo_dinov2_Coffee_Preperation_D1_BSPLINE_GTMIX_p${GT_MIX_P} \

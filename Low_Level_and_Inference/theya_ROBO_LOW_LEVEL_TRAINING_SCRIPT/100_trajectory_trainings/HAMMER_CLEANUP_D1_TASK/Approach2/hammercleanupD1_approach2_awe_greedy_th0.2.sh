...
#SBATCH --job-name hammer-cleanup-d1-approach2-awe-greedy-th0.2
#SBATCH -o /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/hammer-cleanup-d1-approach2-awe-greedy-th0.2_job_%j.out
#SBATCH -e /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/hammer-cleanup-d1-approach2-awe-greedy-th0.2_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 (GMM-as-auxiliary-loss) on HAMMER_CLEANUP_D1  —  goal_source=awe (greedy, err_th=0.2), c1=0.1
# ===========================================================================
...
# hammercleanupD1_approach2_awe.sh. This tree holds AWE subgoals produced by
...
#
# EXTRA_KEYPOINTS_awe-greedy-th0.2/HAMMER_CLEANUP_D1 has been verified to
...
EXTRA_GOALS_DIR="/jet/home/eswaramo/data/D2/EXTRA_KEYPOINTS/EXTRA_KEYPOINTS_awe-greedy-th0.2/HAMMER_CLEANUP_D1"

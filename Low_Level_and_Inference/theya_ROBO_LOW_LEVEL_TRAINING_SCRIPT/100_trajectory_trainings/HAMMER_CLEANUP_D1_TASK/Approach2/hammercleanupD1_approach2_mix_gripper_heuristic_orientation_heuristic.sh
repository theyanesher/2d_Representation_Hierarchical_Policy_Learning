...
#SBATCH --job-name hammer-cleanup-d1-approach2-mix_gripper_heuristic_orientation_heuristic
#SBATCH -o /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/hammer-cleanup-d1-approach2-mix_gripper_heuristic_orientation_heuristic_job_%j.out
#SBATCH -e /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/hammer-cleanup-d1-approach2-mix_gripper_heuristic_orientation_heuristic_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 (GMM-as-auxiliary-loss) on HAMMER_CLEANUP_D1  —  goal_source=mix_gripper_heuristic_orientation_heuristic, c1=0.1
# ===========================================================================
...
#
# This variant supervises the GMM head with the mix_gripper_heuristic_orientation_heuristic keypoint field
# from the EXTRA_KEYPOINTS tree (goal_gripper_pcd_mix_gripper_heuristic_orientation_heuristic) instead of
...
#      +task.dataset.goal_source=mix_gripper_heuristic_orientation_heuristic and policy.aux_gmm_loss_weight=0.1.
#
...
GOAL_SOURCE="mix_gripper_heuristic_orientation_heuristic"
C1=0.1
...
# The 2026-08-16 06:48 run (job 43679715) hit "OSError: disk quota exceeded"
# partway through epoch 10 and died. epoch_10.ckpt / latest.ckpt from that run
# are intact (verified as valid zip checkpoints), so default to resuming from
# there. Override (e.g. RESUME_CKPT= to force a fresh run, or a different
...
RESUME_CKPT="${RESUME_CKPT-/jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/outputs/2026.08.16/06.48.32_hammercleanup_D1_APPROACH2_mix_gripper_heuristic_orientation_heuristic_c1_0.1_100demo_dinov2_DIT_hammercleanup_D1_goal_gmm_aux/checkpoints/latest.ckpt}"

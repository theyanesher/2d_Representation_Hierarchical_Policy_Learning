...
#SBATCH --job-name hammer-cleanup-d1-approach2-awe-dp
#SBATCH -o /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/hammer-cleanup-d1-approach2-awe-dp_job_%j.out
#SBATCH -e /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/hammer-cleanup-d1-approach2-awe-dp_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 (GMM-as-auxiliary-loss) on HAMMER_CLEANUP_D1  —  goal_source=awe (DP subgoals), c1=0.1
# ===========================================================================
...
# hammercleanupD1_approach2_awe.sh. This tree holds AWE subgoals derived
# from the DP (diffusion-policy) rollout rather than the original heuristic
# used for the combined tree's 'awe' column — the two are NOT numerically
# identical even though they share the same npz key name. c1=0.1 is the
# established "start here" auxiliary-loss weight for Approach 2 (see the
# sibling *_c1_0.1.sh scripts in
...
# generated: HAMMER_CLEANUP_D1 only has ~65/100 demo_N/ dirs and they are
# NOT contiguous from demo_0 (e.g. demo_1, demo_3, demo_5, demo_10, demo_11
# are missing). The injection step stages demo_0.h5 .. demo_(NUM_DEMOS-1).h5
# sequentially and will raise FileNotFoundError the first time it hits a
# demo_N with no matching EXTRA_KEYPOINTS_awe/HAMMER_CLEANUP_D1/demo_N dir.
# Check current coverage before submitting:
#   ls /jet/home/eswaramo/data/D2/EXTRA_KEYPOINTS/EXTRA_KEYPOINTS_awe/HAMMER_CLEANUP_D1 | wc -l
# and set NUM_DEMOS to the largest N such that demo_0..demo_(N-1) all exist,
# or wait for generation to finish.
#
...
EXTRA_GOALS_DIR="/jet/home/eswaramo/data/D2/EXTRA_KEYPOINTS/EXTRA_KEYPOINTS_awe/HAMMER_CLEANUP_D1"

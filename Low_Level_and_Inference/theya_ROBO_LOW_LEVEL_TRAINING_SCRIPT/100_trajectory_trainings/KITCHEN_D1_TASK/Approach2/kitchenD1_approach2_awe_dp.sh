...
#SBATCH --job-name kitchen-d1-approach2-awe-dp
#SBATCH -o /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/kitchen-d1-approach2-awe-dp_job_%j.out
#SBATCH -e /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/kitchen-d1-approach2-awe-dp_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 (GMM-as-auxiliary-loss) on KITCHEN_D1  —  goal_source=awe (DP subgoals), c1=0.1
# ===========================================================================
...
# kitchenD1_approach2_awe.sh. This tree holds AWE subgoals derived from
# the DP (diffusion-policy) rollout rather than the original heuristic used
# for the combined tree's 'awe' column — the two are NOT numerically
...
# generated and does NOT yet have a KITCHEN_D1 subdir at all (only
# HAMMER_CLEANUP_D1 exists so far, and even that is a partial,
...
# EXTRA_KEYPOINTS_awe/KITCHEN_D1/demo_N dir. Do not submit this script
# until that subdir exists with contiguous demo_0..demo_(NUM_DEMOS-1)
# coverage — check with:
#   ls /jet/home/eswaramo/data/D2/EXTRA_KEYPOINTS/EXTRA_KEYPOINTS_awe/KITCHEN_D1 | wc -l
#
...
EXTRA_GOALS_DIR="/jet/home/eswaramo/data/D2/EXTRA_KEYPOINTS/EXTRA_KEYPOINTS_awe/KITCHEN_D1"

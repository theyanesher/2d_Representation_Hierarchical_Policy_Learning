...
#SBATCH --job-name kitchen-d1-approach2-fixed-interval-K30
#SBATCH -o /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/kitchen-d1-approach2-fixed-interval-K30_job_%j.out
#SBATCH -e /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/kitchen-d1-approach2-fixed-interval-K30_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 (GMM-as-auxiliary-loss) on KITCHEN_D1  —  goal_source=fixed_interval, K=30 extra keypoints, c1=0.1
# ===========================================================================
...
# (EXTRA_KEYPOINTS_fixed_interval_K30/KITCHEN_D1) -- fixed_interval keypoints
# spaced K frames apart along the trajectory, K=30 being the second-sparsest
# setting in the sweep {5,10,30,60}. The npz key is goal_gripper_pcd_fixed_interval
...
#
# EXTRA_KEYPOINTS_fixed_interval_K30/KITCHEN_D1 covers demo_0..demo_100 (101

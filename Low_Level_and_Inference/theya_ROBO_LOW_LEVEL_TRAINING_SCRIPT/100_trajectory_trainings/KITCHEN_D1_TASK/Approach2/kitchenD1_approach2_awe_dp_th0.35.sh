...
#SBATCH --job-name kitchen-d1-approach2-awe-dp-th0.35
#SBATCH -o /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/kitchen-d1-approach2-awe-dp-th0.35_job_%j.out
#SBATCH -e /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/kitchen-d1-approach2-awe-dp-th0.35_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 (GMM-as-auxiliary-loss) on KITCHEN_D1  —  goal_source=awe (DP subgoals, err_th=0.35), c1=0.1
# ===========================================================================
...
# the DP (diffusion-policy) rollout at distance-error threshold 0.35
...
#
# EXTRA_KEYPOINTS_awe-dp-th0.35/KITCHEN_D1 has been verified to cover
# demo_0..demo_99 (100/100, contiguous) as of 2026-08-21.
#
...
EXTRA_GOALS_DIR="/jet/home/eswaramo/data/D2/EXTRA_KEYPOINTS/EXTRA_KEYPOINTS_awe-dp-th0.35/KITCHEN_D1"

...
RESUME_CKPT="${RESUME_CKPT-/jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/outputs/2026.08.16/07.06.07_kitchen_D1_APPROACH2_awe_c1_0.1_100demo_dinov2_DIT_kitchen_goal_gmm_aux/checkpoints/epoch_5.ckpt}"

...
#SBATCH --job-name pusht-approach2-awe-greedy-th0.1
#SBATCH -o /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/pusht-approach2-awe-greedy-th0.1_job_%j.out
#SBATCH -e /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/pusht-approach2-awe-greedy-th0.1_job_%j.err
...
# ===========================================================================
# Direct counterpart of PUSHBLOCK_D2_TASK/Approach2/pushblock_approach2_awe_greedy_th0.1.sh
# for PushT_Tasks/push_t_goal_gmm_aux. The low-level policy is NOT given the
...
# (goal_gripper_pcd_awe) sourced from the PushT_EXTRA_KEYPOINTS tree below —
# AWE subgoals produced by the greedy keypoint-selection method at error
# threshold 0.1. That single tree also carries the uvd and
...
# ephemeral) is cheap.
echo "[inject] ensuring obs/goal_gripper_pts_${GOAL_SOURCE} exists in staged demos (from PushT_EXTRA_KEYPOINTS_..._awe-greedy-th0.1_...)"
(
    cd "${REPO_DIR}"
    USE_TF=0 \

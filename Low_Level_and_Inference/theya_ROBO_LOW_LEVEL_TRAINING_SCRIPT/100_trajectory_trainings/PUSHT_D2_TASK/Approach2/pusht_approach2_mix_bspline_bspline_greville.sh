...
#SBATCH --job-name pusht-approach2-mix_bspline_bspline_greville
#SBATCH -o /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/pusht-approach2-mix_bspline_bspline_greville_job_%j.out
#SBATCH -e /jet/home/eswaramo/code/Low_Level_and_Inference/2d_Representation_Hierarchical_Policy_Learning/Low_Level_and_Inference/theya_ROBO_LOW_LEVEL_TRAINING_SCRIPT/logs/pusht-approach2-mix_bspline_bspline_greville_job_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=teswaram@andrew.cmu.edu

# ===========================================================================
# APPROACH 2 (GMM-as-auxiliary-loss) on the real-world PushT task
#                       —  goal_source=mix_bspline_bspline_greville, c1=0.1
# ===========================================================================
# Sibling of pusht_approach2_awe_greedy_th0.1.sh / pusht_approach2_uvd.sh for
...
#
# This variant supervises the GMM head with the mix_bspline_bspline_greville
# keypoint field (goal_gripper_pcd_mix_bspline_bspline_greville — a B-spline
# fit with Greville-abscissae mixture anchors) sourced from the
# PushT_EXTRA_KEYPOINTS tree below — the same tree that also carries the awe
# and uvd sources used by the sibling scripts in this directory, so
# EXTRA_GOALS_DIR is shared across all three.
#
...
SOURCE_TAG="mix_bspline_bspline_greville"
C1=0.1
...
# --- inject obs/goal_gripper_pts_mix_bspline_bspline_greville into the ----
# staged, node-local copy. Reads EXTRA_GOALS_DIR directly (small per-frame
# data, no need to stage it). Only appends a small (T,4,3) array, so redoing

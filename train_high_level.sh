torchrun --standalone --nproc_per_node=1 train_multitask_ddp_weighted_displacement_gmm.py --arg_configs    \
    general.exp_name=fine_tune_mimicgen_square_d2 \
    articubot.batch_size=20   \
    articubot.num_train_objects=mimicgen_square_d2 \
    articubot.is_pickle=0 \
    general.tasks="['articubot']" \
    general.use_lr_scheduler=1 \
    general.load_model_path=/project_data/held/yufeiw2/articubot_multitask/RoboGen-sim2real/test_PointNet2/exps/2026-01-02full-new-pick-place-0101/model_1070001.pth 

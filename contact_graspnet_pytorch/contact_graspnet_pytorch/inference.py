...
def inference(global_config, 
    ...
    for p in glob.glob(input_paths):
        ...
        #     pkl.dump({'pc_full': pc_full, 'pc_segments': pc_segments, 'pc_colors': pc_colors}, f)
        # exit()
        ...
        # import pickle as pkl
        # with open("/media/yufei/42b0d2d4-94e0-45f4-9930-4d8222ae63e51/yufei/projects/RoboGen-sim2real/data/debug/contactgraspnet_predictions.pkl", 'rb') as f:
        #     data = pkl.load(f)
        #     pred_grasps_cam = data["grasp_predictions"]
        #     scores = data["score_predictions"]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--filter_grasps', default=1, type=int,  help='Filter grasp contacts according to segmap.')
    ...
    print("filter grasps: ", FLAGS.filter_grasps)
    # exit()

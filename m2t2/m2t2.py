...
class M2T2(nn.Module):
    ...
    def forward(self, data, cfg):
        ...
        """
        assuming 108 queries (100 grasping and 8 placing), batch size 4
        output lengths: 10 (1 + 9), init query embeddings + 9 layers of transformer outputs
        output keys: dict_keys(['objectness', 'grasping_masks', 'placement_masks'])
        objectness shape: 4, 100
        grasping_masks: 4, 100, 16384
        placement_masks: 4, 8, 16384
        """

...
class ContactDecoder(nn.Module):
    ...
    def predict(self, embed, mask_features):
        # import pdb; pdb.set_trace()
        grasp_embed, place_embed = embed.split([self.num_grasp_queries, self.num_place_queries])

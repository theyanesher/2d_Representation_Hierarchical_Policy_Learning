...
class AcryonymDataset(Dataset):
    ...
    def __init__(self, global_config, debug=False, train=True, device=None, use_saved_renders=False, 
        ...
        self._num_saved_cam_poses = 900  # TODO: Make this a config
    ...
    def __getitem__(self, index):
        ...
        scene_index = index
        if not self.eval_with_fixed_cam:
        ...
        #     print("error loading contact info")
        # except:
    ...
    def __len__(self):
        ...
        """
        if self.train:
            return self._num_train_scenes #* self._num_renderable_cam_poses
        else:
            return self._num_test_scenes #* self._num_renderable_cam_poses
    ...
    def render_scene(self, estimate_normals=False, cam_id=None, camera_pose=None, augment=True):
        """
        ...
        """
        if camera_pose is None and cam_id is None:
        ...
        if cam_id is not None:
            camera_orientation = self._cam_orientations[cam_id]
            camera_pose = self.get_cam_pose(camera_orientation)

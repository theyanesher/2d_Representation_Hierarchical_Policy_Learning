...
#SBATCH -t 2:00:00
#SBATCH --job-name coffee-prep-d1-bspline-pred-gen
#SBATCH -o /ocean/projects/cis240052p/eswaramo/code/2d_Representation_Hierarchical_Policy_Learning/logs/coffee-prep-d1-gmm-bspline-subgoals-100demo_%j.out
#SBATCH -e /ocean/projects/cis240052p/eswaramo/code/2d_Representation_Hierarchical_Policy_Learning/logs/coffee-prep-d1-gmm-bspline-subgoals-100demo_%j.err
...
FINAL_OCEAN_DIR="/jet/home/eswaramo/data/D2/EXTRA_KEYPOINTS/COFFEE_PREPERATION_D1_BSPLINE_GMM_PRED"

# --- checkpoint (EDIT HERE to change) --------------------------------------
CKPT_PATH="${REPO_DIR}/logs/train_COFFEE_PREPERATION_D1_BSPLINE_subgoals_100demo/2026-08-10/13-23-22/checkpoints/epoch=59-step=22500-val/rmse=0.031.ckpt"
if [ ! -f "${CKPT_PATH}" ]; then

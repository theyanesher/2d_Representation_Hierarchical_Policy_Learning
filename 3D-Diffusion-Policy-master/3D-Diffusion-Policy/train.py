...
class TrainDP3Workspace:
    ...
    def run(self):
        ...
        env_runner = hydra.utils.instantiate(
            ...
            oracle_goal_zarr=cfg.task.rollout_path,
            eef_points = cfg.policy.eef_points,
            high_level_ckpt = cfg.high_level_ckpt,
            )
    ...
    def eval(self):
        ...
        #lastest_ckpt_path = pathlib.Path("3D-Diffusion-Policy/data/outputs/dexart_laptop-dp3-08094_seed0/ckpt_per100/300.ckpt")
        if lastest_ckpt_path.is_file():

...
import os
demo_data = 'data/diverse_objects'
all_subdirs = os.listdir(demo_data)

for dir in all_subdirs:
    experiment_path = os.path.join(demo_data, dir, "task_open_the_door_of_the_storagefurniture_by_its_handle/experiment/0705-diverse-objects-vary-obj-loc-ori-init-angle-robot-init-joint-near-handle-300-demo-0.4-0.15-translation-first")
